...
dbm.registerClass("dbm.nodejs.core.globalobjects.assetrepository.assets.HttpLoadedAsset", "dbm.core.globalobjects.assetrepository.assets.Asset", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.nodejs.core.globalobjects.assetrepository.assets.HttpLoadedAsset");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.nodejs.core.globalobjects.assetrepository.assets.HttpLoadedAsset::_init");
	...
	objectFunctions.setUrl = function(aUrl) {
		//console.log("dbm.nodejs.core.globalobjects.assetrepository.assets.HttpLoadedAsset::setUrl");
		//console.log(aUrl);
	...
	objectFunctions.load = function() {
		console.log("dbm.nodejs.core.globalobjects.assetrepository.assets.HttpLoadedAsset::load");
	...
	objectFunctions._firstResponse = function(aResponse) {
		//console.log("dbm.nodejs.core.globalobjects.assetrepository.assets.HttpLoadedAsset::_firstResponse");
	...
	objectFunctions._addResponseData = function(aData) {
		//console.log("dbm.nodejs.core.globalobjects.assetrepository.assets.HttpLoadedAsset::_addResponseData");
		//console.log(aData);
	...
	objectFunctions._responseDone = function() {
		//console.log("dbm.nodejs.core.globalobjects.assetrepository.assets.HttpLoadedAsset::_responseDone");
