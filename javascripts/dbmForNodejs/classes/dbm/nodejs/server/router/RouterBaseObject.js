 ...
 */
dbm.registerClass("dbm.nodejs.server.router.RouterBaseObject", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.nodejs.server.router.RouterBaseObject");
	//"use strict";
	
	//Self reference
	var RouterBaseObject = dbm.importClass("dbm.nodejs.server.router.RouterBaseObject");
	...
	objectFunctions._init = function() {
		//console.log("dbm.nodejs.server.router.RouterBaseObject::_init");
	...
	objectFunctions._qualifyRouting = function(aRoutedData) {
		//console.log("dbm.nodejs.server.router.RouterBaseObject::_qualifyRouting");
		//console.log(this);
	...
	objectFunctions.route = function(aRoutedData) {
		//console.log("dbm.nodejs.server.router.RouterBaseObject::route");
	...
	staticFunctions.create = function() {
		//console.log("dbm.nodejs.server.router.RouterBaseObject::create");
