 ...
 */
dbm.registerClass("dbm.nodejs.server.router.qualifiers.EqualsQualifier", "dbm.nodejs.server.router.qualifiers.QualifierBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.nodejs.server.router.qualifiers.EqualsQualifier");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.nodejs.server.router.qualifiers.EqualsQualifier::_init");
	...
	staticFunctions.create = function(aFirstValue, aSecondValue) {
		//console.log("dbm.nodejs.server.router.qualifiers.EqualsQualifier::create");
