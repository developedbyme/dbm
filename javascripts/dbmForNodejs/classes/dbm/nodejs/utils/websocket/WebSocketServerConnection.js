...
dbm.registerClass("dbm.nodejs.utils.websocket.WebSocketServerConnection", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.nodejs.utils.websocket.WebSocketServerConnection");
	//"use strict";
	...
	objectFunctions._handleRawFrame = function(aFrame) {
		//console.log("dbm.nodejs.utils.websocket.WebSocketServerConnection::_handleRawFrame");
	...
	objectFunctions.sendRawBuffer = function(aBuffer, aOpcode) {
		//console.log("dbm.nodejs.utils.websocket.WebSocketServerConnection::sendRawBuffer");
	...
	objectFunctions.sendRawText = function(aText) {
		//console.log("dbm.nodejs.utils.websocket.WebSocketServerConnection::sendRawText");
		//console.log(aText);
