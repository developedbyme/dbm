...
dbm.registerClass("dbm.nodejs.utils.file.FolderCreator", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.nodejs.utils.file.FolderCreator");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.nodejs.utils.file.FolderCreator::_init");
	...
	objectFunctions._callback_exists = function(aExists) {
		//console.log("dbm.nodejs.utils.file.FolderCreator::_callback_exists");
	...
	objectFunctions._callback_created = function(aError) {
		//console.log("dbm.nodejs.utils.file.FolderCreator::_callback_created");
	...
	staticFunctions.create = function(aUrl) {
		//console.log("dbm.nodejs.utils.file.FolderCreator::create");
		//console.log(aUrl);
	...
	staticFunctions.createFromFilePath = function(aUrl) {
		//console.log("dbm.nodejs.utils.file.FolderCreator::createFromFilePath");
		//console.log(aUrl);
