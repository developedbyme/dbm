...
dbm.registerClass("com.developedbyme.nodejs.utils.websocket.WebSocketServerFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.nodejs.utils.websocket.WebSocketServerFunctions");
	//"use strict";
	...
	staticFunctions.encodeKeyValueHybi06 = function(aKey) {
		//console.log("com.developedbyme.nodejs.utils.websocket.WebSocketServerFunctions::encodeKeyValueHybi06");
	...
	staticFunctions.connectUpgradeHybi00 = function(aRequest, aSocket, aBody, aOrigin, aLocation) {
		console.log("com.developedbyme.nodejs.utils.websocket.WebSocketServerFunctions::connectUpgradeHybi00");
	...
	staticFunctions.connectUpgradeHybi06 = function(aRequest, aSocket, aBody) {
		console.log("com.developedbyme.nodejs.utils.websocket.WebSocketServerFunctions::connectUpgradeHybi06");
		aSocket.setTimeout(0);
		aSocket.setNoDelay(true);
		aSocket.setKeepAlive(true, 0);
	...
	staticFunctions.isWebSocketUpgrade = function(aRequest) {
		console.log("com.developedbyme.nodejs.utils.websocket.WebSocketServerFunctions::isWebSocketUpgrade");
