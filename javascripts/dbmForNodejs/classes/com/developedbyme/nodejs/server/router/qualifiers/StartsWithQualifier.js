 ...
 */
dbm.registerClass("com.developedbyme.nodejs.server.router.qualifiers.StartsWithQualifier", "com.developedbyme.nodejs.server.router.qualifiers.QualifierBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.nodejs.server.router.qualifiers.StartsWithQualifier");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.nodejs.server.router.qualifiers.StartsWithQualifier::_init");
	...
	staticFunctions.create = function(aSearchString, aFullString) {
		//console.log("com.developedbyme.nodejs.server.router.qualifiers.StartsWithQualifier::create");
