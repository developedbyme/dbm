...
dbm.registerClass("com.developedbyme.nodejs.core.globalobjects.encodingmanager.encoders.HmacEncoder", "com.developedbyme.core.globalobjects.encodingmanager.encoders.EncodingBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.nodejs.core.globalobjects.encodingmanager.encoders.HmacEncoder");
	
	var crypto = require("crypto");
	
	//Self reference
	var HmacEncoder = dbm.importClass("com.developedbyme.nodejs.core.globalobjects.encodingmanager.encoders.HmacEncoder");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.nodejs.core.globalobjects.encodingmanager.encoders.HmacEncoder::_init");
	...
	objectFunctions.encode = function() {
		console.log("com.developedbyme.nodejs.core.globalobjects.encodingmanager.encoders.HmacEncoder::encode");
