...
dbm.registerClass("com.developedbyme.nodejs.core.globalobjects.assetrepository.assets.HttpsLoadedAsset", "com.developedbyme.core.globalobjects.assetrepository.assets.Asset", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.nodejs.core.globalobjects.assetrepository.assets.HttpsLoadedAsset");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.nodejs.core.globalobjects.assetrepository.assets.HttpsLoadedAsset::_init");
	...
	objectFunctions.setUrl = function(aUrl) {
		//console.log("com.developedbyme.nodejs.core.globalobjects.assetrepository.assets.HttpsLoadedAsset::setUrl");
		//console.log(aUrl);
	...
	objectFunctions.load = function() {
		console.log("com.developedbyme.nodejs.core.globalobjects.assetrepository.assets.HttpsLoadedAsset::load");
	...
	objectFunctions._firstResponse = function(aResponse) {
		//console.log("com.developedbyme.nodejs.core.globalobjects.assetrepository.assets.HttpsLoadedAsset::_firstResponse");
	...
	objectFunctions._addResponseData = function(aData) {
		//console.log("com.developedbyme.nodejs.core.globalobjects.assetrepository.assets.HttpsLoadedAsset::_addResponseData");
		//console.log(aData);
	...
	objectFunctions._responseDone = function() {
		//console.log("com.developedbyme.nodejs.core.globalobjects.assetrepository.assets.HttpsLoadedAsset::_responseDone");
