 ...
 */
dbm.registerClass("com.developedbyme.projects.tests.math.curves.ArcLengthOfCurveApplication", "com.developedbyme.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.BaseObject");
	
	//Self reference
	var ArcLengthOfCurveApplication = dbm.importClass("com.developedbyme.projects.tests.math.curves.ArcLengthOfCurveApplication");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.projects.tests.math.curves.ArcLengthOfCurveApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("com.developedbyme.projects.tests.math.curves.ArcLengthOfCurveApplication::_createPage");
