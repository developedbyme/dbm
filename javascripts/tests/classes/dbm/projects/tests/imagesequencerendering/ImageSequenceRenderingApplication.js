...
dbm.registerClass("dbm.projects.tests.imagesequencerendering.ImageSequenceRenderingApplication", "dbm.gui.DisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.projects.tests.imagesequencerendering.ImageSequenceRenderingApplication");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.projects.tests.imagesequencerendering.ImageSequenceRenderingApplication::_init");
	...
	objectFunctions._createCanvases = function(aNumberOfCanvases, aCanvasWidth, aCanvasHeight) {
		//console.log("dbm.projects.tests.imagesequencerendering.ImageSequenceRenderingApplication::_createCanvases");
	...
	objectFunctions.start = function() {
		//console.log("dbm.projects.tests.imagesequencerendering.ImageSequenceRenderingApplication::start");
	...
	staticFunctions.create = function(aElement, aNumberOfCanvases, aCanvasWidth, aCanvasHeight, aImageSequences) {
		//console.log("dbm.projects.tests.imagesequencerendering.ImageSequenceRenderingApplication::create");
