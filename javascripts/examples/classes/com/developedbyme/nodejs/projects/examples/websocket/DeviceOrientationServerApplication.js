dbm.registerClass("com.developedbyme.nodejs.projects.examples.websocket.DeviceOrientationServerApplication", "com.developedbyme.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.BaseObject");
	
	//Self reference
	var DeviceOrientationServerApplication = dbm.importClass("com.developedbyme.nodejs.projects.examples.websocket.DeviceOrientationServerApplication");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.nodejs.projects.examples.websocket.DeviceOrientationServerApplication::_init");
	...
	objectFunctions.start = function() {
		console.log("com.developedbyme.nodejs.projects.examples.websocket.DeviceOrientationServerApplication::start");
