 ...
 */
dbm.registerClass("com.developedbyme.projects.examples.graphics.canvas.DrawGradientApplication", "com.developedbyme.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.BaseObject");
	
	//Self reference
	var DrawGradientApplication = dbm.importClass("com.developedbyme.projects.examples.graphics.canvas.DrawGradientApplication");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.projects.examples.graphics.canvas.DrawGradientApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("com.developedbyme.projects.examples.graphics.canvas.DrawGradientApplication::_createPage");
