 ...
 */
dbm.registerClass("com.developedbyme.projects.examples.device.DeviceLocationApplication", "com.developedbyme.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.projects.examples.device.DeviceLocationApplication");
	
	//Self reference
	var DeviceLocationApplication = dbm.importClass("com.developedbyme.projects.examples.device.DeviceLocationApplication");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.projects.examples.device.DeviceLocationApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("com.developedbyme.projects.examples.device.DeviceLocationApplication::_createPage");
