 ...
 */
dbm.registerClass("com.developedbyme.projects.examples.gui.form.InputFieldListApplication", "com.developedbyme.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.BaseObject");
	
	//Self reference
	var InputFieldListApplication = dbm.importClass("com.developedbyme.projects.examples.gui.form.InputFieldListApplication");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.projects.examples.gui.form.InputFieldListApplication::_init");
	...
	objectFunctions._createPage = function() {
		//console.log("com.developedbyme.projects.examples.gui.form.InputFieldListApplication::_createPage");
	...
	objectFunctions._valueUpdated = function(aValue) {
		console.log("com.developedbyme.projects.examples.gui.form.InputFieldListApplication::_valueUpdated");
		console.log(aValue);
	};
	
	objectFunctions.createNewField = function() {
		//console.log("com.developedbyme.projects.examples.gui.form.InputFieldListApplication::createNewField");
	...
	objectFunctions.destroyLastField = function() {
		//console.log("com.developedbyme.projects.examples.gui.form.InputFieldListApplication::destroyLastField");
