...
dbm.registerClass("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication", "dbm.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.BaseObject");
	
	//Self reference
	var DrawAnimationApplication = dbm.importClass("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication");
	...
	var CanvasImageGraphics2d = dbm.importClass("dbm.utils.canvas.CanvasImageGraphics2d");
	...
	var CurveDrawer2d = dbm.importClass("dbm.utils.canvas.CurveDrawer2d");
	var CreateWedgeInBoxCurveNode = dbm.importClass("dbm.flow.nodes.curves.CreateWedgeInBoxCurveNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::_createPage");
	...
	objectFunctions.setupLayerTreeStructure = function(aTreeStructureItem, aLayer, aTimeProperty, aDuration, aCompositions, aShowHiddenLayers) {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::setupLayerTreeStructure");
	...
	objectFunctions.setupLayer = function(aLayer, aAnimationData, aTimeProperty, aFullDuration, aCompositions, aShowHiddenLayers) {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::setupLayer");
	...
	objectFunctions._sortLayerZIndex = function(aTreeStructureItem) {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::_sortLayerZIndex");
	...
	objectFunctions.generateShapes = function(aCurrentLayer, aCurrentGroup, aTimelines, aTimeProperty, aCurves) {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::generateShapes");
	...
	objectFunctions._trimCurves = function(aGraphicsArray, aStartParameter, aEndParameter, aLoopEndParameter) {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::_trimCurves");
	...
	objectFunctions.drawVectorLayer = function(aAsset, aLayerName, aParentLayer, aHolderWidth, aHolderHeight) {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::drawVectorLayer");
	...
	objectFunctions._performDrawVectorLayer = function(aAsset, aLayerName, aParentLayer, aHolderWidth, aHolderHeight) {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::_performDrawVectorLayer");
		//console.log(aAsset, aLayerName, aParentLayer);
	...
	objectFunctions._performDrawSingleVectorLayer = function(aLayerData, aParentLayer, aHolderWidth, aHolderHeight, aIsFullSize) {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::_performDrawSingleVectorLayer");
	...
	objectFunctions._linkDataToProperty = function(aDataProperty, aTimeProperty, aOutputProperty) {
		//console.log("dbm.projects.examples.animation.aftereffectsimport.DrawAnimationApplication::_linkDataToPropert");
