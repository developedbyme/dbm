...
dbm.registerClass("dbm.projects.examples.websocket.DeviceOrientationApplication", "dbm.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.BaseObject");
	
	//Self reference
	var DeviceOrientationApplication = dbm.importClass("dbm.projects.examples.websocket.DeviceOrientationApplication");
	...
	objectFunctions._init = function() {
		//console.log("dbm.projects.examples.websocket.DeviceOrientationApplication::_init");
	...
	objectFunctions._connect = function(aUrl) {
		console.log("dbm.projects.examples.websocket.DeviceOrientationApplication::_connect");
	...
	objectFunctions._createOutgoingFlow = function() {
		console.log("dbm.projects.examples.websocket.DeviceOrientationApplication::_createOutgoingFlow");
	...
	objectFunctions._createIncomingFlow = function() {
		console.log("dbm.projects.examples.websocket.DeviceOrientationApplication::_createIncomingFlow");
