 ...
 */
dbm.registerClass("dbm.projects.examples.compiler.DocumentFilesApplication", "dbm.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.projects.examples.compiler.DocumentFilesApplication");
	
	//Self reference
	var DocumentFilesApplication = dbm.importClass("dbm.projects.examples.compiler.DocumentFilesApplication");
	...
	var TemplateWithCommands = dbm.importClass("dbm.utils.templates.TemplateWithCommands");
	...
	var RebaseDocumentLinksCommand = dbm.importClass("dbm.core.extendedevent.commands.htmldom.RebaseDocumentLinksCommand");
	...
	var TreeStructureFunctions = dbm.importClass("dbm.utils.data.treestructure.TreeStructureFunctions");
	...
	objectFunctions._init = function() {
		//console.log("dbm.projects.examples.compiler.DocumentFilesApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("dbm.projects.examples.compiler.DocumentFilesApplication::_createPage");
		
		var compiler = (new DbmCompiler()).init();
		
		compiler.setNumberOfFilesBeforeImport(3);
		compiler.addFiles("../javascripts/dbm/dbm.js", "../javascripts/dbm/setup/defaultDocumentSetup.js", "../javascripts/dbm/classes/dbm/core/globalobjects/classmanager/ClassManager.js", "../javascripts/dbm/setup/defaultSetup.js", "../javascripts/dbm/setup/compiledStart.js", "../javascripts/tests/inverseKinematicTest.js");
	...
	objectFunctions._generateDocumentation = function(aCompiler) {
		console.log("dbm.projects.examples.compiler.DocumentFilesApplication::_generateDocumentation");
	...
	objectFunctions._saveClassDocumentation = function(aFilePath, aHtmlDocument) {
		//console.log("dbm.projects.examples.compiler.DocumentFilesApplication::_saveClassDocumentation");
	...
	objectFunctions.insertArgumentsDefinition = function(aHolderElement, aDescriptionHolderElement, aArguments, aDocumentation, aClassPaths) {
		//console.log("dbm.projects.examples.compiler.DocumentFilesApplication::insertArgumentsDefinition");
	...
	objectFunctions.insertReturnValueDefinition = function(aHolderElement, aDescriptionHolderElement, aReturnValueType, aDocumentation, aClassPaths) {
		//console.log("dbm.projects.examples.compiler.DocumentFilesApplication::insertReturnValueDefinition");
