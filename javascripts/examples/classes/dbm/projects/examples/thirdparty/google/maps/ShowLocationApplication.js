 ...
 */
dbm.registerClass("dbm.projects.examples.thirdparty.google.maps.ShowLocationApplication", "dbm.projects.examples.thirdparty.google.maps.CreateMapApplication", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.BaseObject");
	
	//Self reference
	var ShowLocationApplication = dbm.importClass("dbm.projects.examples.thirdparty.google.maps.ShowLocationApplication");
	...
	objectFunctions._init = function() {
		//console.log("dbm.projects.examples.thirdparty.google.maps.ShowLocationApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("dbm.projects.examples.thirdparty.google.maps.ShowLocationApplication::_createPage");
