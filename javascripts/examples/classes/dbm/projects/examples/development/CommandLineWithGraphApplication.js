...
dbm.registerClass("dbm.projects.examples.development.CommandLineWithGraphApplication", "dbm.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.BaseObject");
	
	//Self reference
	var CommandLineWithGraphApplication = dbm.importClass("dbm.projects.examples.development.CommandLineWithGraphApplication");
	...
	objectFunctions._init = function() {
		//console.log("dbm.projects.examples.development.CommandLineWithGraphApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("dbm.projects.examples.development.CommandLineWithGraphApplication::_createPage");
	...
	objectFunctions._executeCurrentScript = function() {
		console.log("dbm.projects.examples.development.CommandLineWithGraphApplication::_executeCurrentScript");
