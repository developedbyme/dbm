...
dbm.registerClass("dbm.projects.examples.development.CommandLineWithVisualResultApplication", "dbm.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.BaseObject");
	
	//Self reference
	var CommandLineWithVisualResultApplication = dbm.importClass("dbm.projects.examples.development.CommandLineWithVisualResultApplication");
	...
	objectFunctions._init = function() {
		//console.log("dbm.projects.examples.development.CommandLineWithVisualResultApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("dbm.projects.examples.development.CommandLineWithVisualResultApplication::_createPage");
	...
	objectFunctions._executeCurrentScript = function() {
		console.log("dbm.projects.examples.development.CommandLineWithVisualResultApplication::_executeCurrentScript");
