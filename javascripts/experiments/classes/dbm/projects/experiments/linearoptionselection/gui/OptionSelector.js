...
dbm.registerClass("dbm.projects.experiments.linearoptionselection.gui.OptionSelector", "dbm.gui.DisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector::_init");
	...
	objectFunctions._createOption = function(aData, aIndex) {
		//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector::_createOption");
	...
	objectFunctions._createOptions = function() {
		//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector::_createOptions");
	...
	objectFunctions.showOptions = function(aDelay) {
		//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector::showOptions");
	...
	objectFunctions.hideOptions = function(aDelay) {
		//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector::hideOptions");
		
		this._envelope.animateValue(0, 0.3, InterpolationTypes.INVERTED_QUADRATIC, aDelay);
	};
	
	objectFunctions.startMoving = function() {
		//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector::startMoving");
		
		this._startMovingItemIndex = this._selectedItem.getValue();
	};
	
	objectFunctions.updateMoving = function(aLength) {
		//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector::updateMoving");
		//console.log(aLength);
	...
	objectFunctions.stopMoving = function(aLength) {
		//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector::stopMoving");
	...
	staticFunctions.create = function(aElement) {
		//console.log("dbm.projects.experiments.linearoptionselection.gui.OptionSelector::create");
