...
dbm.registerClass("dbm.projects.experiments.linearoptionselection.LinearOptionSelectionApplication", "dbm.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.projects.experiments.linearoptionselection.LinearOptionSelectionApplication");
	//"use strict";
	
	//Self reference
	var LinearOptionSelectionApplication = dbm.importClass("dbm.projects.experiments.linearoptionselection.LinearOptionSelectionApplication");
	...
	var OptionSelector = dbm.importClass("dbm.projects.experiments.linearoptionselection.gui.OptionSelector");
	...
	objectFunctions._init = function() {
		console.log("dbm.projects.experiments.linearoptionselection.LinearOptionSelectionApplication::_init");
	...
	objectFunctions._changeShowingItem = function(aIndex, aDelay) {
		//console.log("dbm.projects.experiments.linearoptionselection.LinearOptionSelectionApplication::_changeShowingItem");
		//console.log(aIndex);
	...
	objectFunctions._createNewOption = function() {
		//console.log("dbm.projects.experiments.linearoptionselection.LinearOptionSelectionApplication::_createNewOption");
	...
	objectFunctions._touchStarted = function() {
		//console.log("dbm.projects.experiments.linearoptionselection.LinearOptionSelectionApplication::_touchStarted");
	...
	objectFunctions._touchUpdate = function() {
		//console.log("dbm.projects.experiments.linearoptionselection.LinearOptionSelectionApplication::_touchUpdate");
	...
	objectFunctions._touchEnded = function() {
		//console.log("dbm.projects.experiments.linearoptionselection.LinearOptionSelectionApplication::_touchEnded");
