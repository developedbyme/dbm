...
dbm.registerClass("dbm.adobeflashscript.flash.items.elements.ShapeElementItem", "dbm.adobeflashscript.flash.items.elements.ElementItem", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.adobeflashscript.flash.items.elements.ShapeElementItem");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.adobeflashscript.flash.items.elements.ShapeElementItem::_init");
	...
	objectFunctions.setupParts = function() {
		//console.log("dbm.adobeflashscript.flash.items.elements.ShapeElementItem::setupParts");
	...
	objectFunctions._createCurveFromHalfEdge = function(aHalfEdge, aOrientation, aShouldBeFirstHalf, aMatrix) {
		//console.log("dbm.adobeflashscript.flash.items.elements.ShapeElementItem::_createCurveFromHalfEdge");
	...
	staticFunctions.create = function(aNativeItem) {
		//console.log("dbm.adobeflashscript.flash.items.elements.ShapeElementItem::create");
		//console.log(aPort);
