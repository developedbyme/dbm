...
dbm.registerClass("dbm.adobeflashscript.flash.items.LayerItem", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.adobeflashscript.flash.items.LayerItem");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.adobeflashscript.flash.items.LayerItem::_init");
	...
	objectFunctions.setupElements = function() {
		console.log("dbm.adobeflashscript.flash.items.LayerItem::setupElements");
	...
	objectFunctions._createNewElement = function(aNativeElement, aStartTime, aEndTime, aReturnArray) {
		//console.log("dbm.adobeflashscript.flash.items.LayerItem::_createNewElement");
	...
	objectFunctions._createElementForElements = function(aNativeElements, aStartTime, aEndTime, aReturnArray) {
		//console.log("dbm.adobeflashscript.flash.items.LayerItem::_createElementForElements");
	...
	staticFunctions.create = function(aNativeItem) {
		//console.log("dbm.adobeflashscript.flash.items.LayerItem::create");
		//console.log(aPort);
