...
dbm.registerClass("com.developedbyme.adobeflashscript.flash.FlashDocument", "com.developedbyme.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.adobeflashscript.flash.FlashDocument");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.adobeflashscript.flash.FlashDocument::_init");
	...
	objectFunctions.setupItems = function() {
		//console.log("com.developedbyme.adobeflashscript.flash.FlashDocument::setupItems");
	...
	staticFunctions.create = function() {
		//console.log("com.developedbyme.adobeflashscript.flash.FlashDocument::create");
		//console.log(aPort);
