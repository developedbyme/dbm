 ...
 */
dbm.registerClass("com.developedbyme.adobeextendscript.projects.tools.photoshop.ExportLayersFromFilesApplication", "com.developedbyme.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.BaseObject");
	
	//Self reference
	var ExportLayersFromFilesApplication = dbm.importClass("com.developedbyme.adobeextendscript.projects.tools.photoshop.ExportLayersFromFilesApplication");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.adobeextendscript.projects.tools.photoshop.ExportLayersFromFilesApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("com.developedbyme.adobeextendscript.projects.tools.photoshop.ExportLayersFromFilesApplication::_createPage");
	...
	objectFunctions._exportLayers = function(aDocument, aExportData) {
		//console.log("com.developedbyme.adobeextendscript.projects.tools.photoshop.ExportLayersFromFilesApplication::_exportLayers");
