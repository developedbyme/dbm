 ...
 */
dbm.registerClass("dbm.adobeextendscript.projects.tools.photoshop.ExportLayersApplication", "dbm.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.BaseObject");
	
	//Self reference
	var ExportLayersApplication = dbm.importClass("dbm.adobeextendscript.projects.tools.photoshop.ExportLayersApplication");
	...
	objectFunctions._init = function() {
		//console.log("dbm.adobeextendscript.projects.tools.photoshop.ExportLayersApplication::_init");
	...
	objectFunctions._createPage = function() {
		console.log("dbm.adobeextendscript.projects.tools.photoshop.ExportLayersApplication::_createPage");
	...
	objectFunctions._exportLayers = function(aLayers, aDocument, aFolderPath) {
		console.log("dbm.adobeextendscript.projects.tools.photoshop.ExportLayersApplication::_exportLayers");
