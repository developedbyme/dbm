...
dbm.registerClass("dbm.adobeextendscript.illustrator.items.layers.LayerBaseObject", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.adobeextendscript.illustrator.items.layers.LayerBaseObject");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.adobeextendscript.illustrator.items.layers.LayerBaseObject::_init");
	...
	objectFunctions.setupItem = function(aNativeItem) {
		//console.log("dbm.adobeextendscript.illustrator.items.layers.LayerBaseObject::setupItem");
	...
	staticFunctions.create = function(aNativeItem) {
		//console.log("dbm.adobeextendscript.illustrator.items.layers.LayerBaseObject::create");
