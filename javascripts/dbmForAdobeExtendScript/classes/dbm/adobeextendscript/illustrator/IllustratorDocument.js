...
dbm.registerClass("dbm.adobeextendscript.illustrator.IllustratorDocument", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.adobeextendscript.illustrator.IllustratorDocument");
	//"use strict";
	...
	var LayerBaseObject = dbm.importClass("dbm.adobeextendscript.illustrator.items.layers.LayerBaseObject");
	...
	objectFunctions._init = function() {
		//console.log("dbm.adobeextendscript.illustrator.IllustratorDocument::_init");
	...
	objectFunctions.setupLayers = function() {
		//console.log("dbm.adobeextendscript.illustrator.IllustratorDocument::setupLayers");
	...
	objectFunctions._setupLayersRecursive = function(aLayers, aParentNativeLayer, aParentTreeStructureItem) {
		//console.log("dbm.adobeextendscript.illustrator.IllustratorDocument::_setupLayersRecursive");
	...
	staticFunctions.create = function(aDocument) {
		//console.log("dbm.adobeextendscript.illustrator.IllustratorDocument::create");
