 ...
 */
dbm.registerClass("dbm.adobeextendscript.illustrator.utils.color.NativeColorConverter", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.adobeextendscript.illustrator.utils.color.NativeColorConverter");
	//"use strict";
	...
	staticFunctions.convertNativeObject = function(aNativeObject) {
		//console.log("dbm.adobeextendscript.illustrator.utils.color.NativeColorConverter::convertNativeObject");
