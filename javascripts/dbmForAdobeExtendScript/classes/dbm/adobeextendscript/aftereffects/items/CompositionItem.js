...
dbm.registerClass("dbm.adobeextendscript.aftereffects.items.CompositionItem", "dbm.adobeextendscript.aftereffects.items.ItemBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.adobeextendscript.aftereffects.items.CompositionItem");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.adobeextendscript.aftereffects.items.CompositionItem::_init");
	...
	objectFunctions.setupItem = function(aNativeItem) {
		//console.log("dbm.adobeextendscript.aftereffects.items.CompositionItem::setupItem");
	...
	staticFunctions.create = function(aNativeItem) {
		//console.log("dbm.adobeextendscript.aftereffects.items.CompositionItem::create");
