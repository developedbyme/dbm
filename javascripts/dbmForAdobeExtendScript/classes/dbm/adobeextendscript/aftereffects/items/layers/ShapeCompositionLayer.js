...
dbm.registerClass("dbm.adobeextendscript.aftereffects.items.layers.ShapeCompositionLayer", "dbm.adobeextendscript.aftereffects.items.layers.AvCompositionLayer", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.adobeextendscript.aftereffects.items.layers.ShapeCompositionLayer");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.adobeextendscript.aftereffects.items.layers.ShapeCompositionLayer::_init");
	...
	objectFunctions.setupAnimationProperties = function() {
		//console.log("dbm.adobeextendscript.aftereffects.items.layers.ShapeCompositionLayer::setupAnimationProperties");
	...
	staticFunctions.create = function(aNativeItem) {
		//console.log("dbm.adobeextendscript.aftereffects.items.layers.ShapeCompositionLayer::create");
