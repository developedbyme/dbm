...
dbm.registerClass("dbm.adobeextendscript.aftereffects.items.layers.LayerBaseObject", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.adobeextendscript.aftereffects.items.layers.LayerBaseObject");
	//"use strict";
	
	//Self reference
	var LayerBaseObject = dbm.importClass("dbm.adobeextendscript.aftereffects.items.layers.LayerBaseObject");
	...
	objectFunctions._init = function() {
		//console.log("dbm.adobeextendscript.aftereffects.items.layers.LayerBaseObject::_init");
	...
	objectFunctions.setupItem = function(aNativeItem) {
		//console.log("dbm.adobeextendscript.aftereffects.items.layers.LayerBaseObject::setupItem");
	...
	staticFunctions.getPropertiesForLayer = function(aLayer, aPrefix, aReturnArray, aReturnMaskArray, aCurrentShape) {
		//console.log("dbm.adobeextendscript.aftereffects.items.layers.LayerBaseObject::getPropertiesForLayer");
	...
	staticFunctions.create = function(aNativeItem) {
		//console.log("dbm.adobeextendscript.aftereffects.items.layers.LayerBaseObject::create");
	...
	staticFunctions.selectParentByNativeParent = function(aLayer, aSearchArray) {
		//console.log("dbm.adobeextendscript.aftereffects.items.layers.LayerBaseObject::selectParentByNativeParent");
