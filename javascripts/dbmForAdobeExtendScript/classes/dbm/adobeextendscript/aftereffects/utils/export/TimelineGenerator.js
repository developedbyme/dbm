 ...
 */
dbm.registerClass("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator");
	//"use strict";
	...
	staticFunctions.createTimelinesForProprety = function(aProperty, aTimelineName, aReturnPropertiesHolder, aExpressions) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::createTimelinesForProprety");
	...
	staticFunctions.getPropertiesForLayer = function(aLayer, aPrefix, aReturnArray) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::getPropertiesForLayer");
	...
	*/
	...
	staticFunctions.setupTimelinesForProperty = function(aProperty, aReturnTimelines, aMultiplier) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::setupTimelinesForProperty");
	...
	staticFunctions.setupTimelinesForSpatialProperty = function(aProperty, aPointProperties, aReturnTimelines, aMultiplier) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::setupTimelinesForSpatialProperty");
		//console.log(aProperty, aReturnTimelines);
	...
	staticFunctions.setupTimelineForShapeProperty = function(aProperty, aReturnTimeline) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::setupTimelineForShapeProperty");
	...
	staticFunctions.createCurveFromShape = function(aShape) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::createCurveFromShape");
		//console.log(aShape);
	...
	staticFunctions.addPartToTimelines = function(aStartTime, aStartValues, aStartInEasing, aStartOutEasing, aEndTime, aEndValues, aEndInEasing, aEndOutEasing, aReturnTimelines, aMultiplier) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::addPartToTimelines");
	...
	staticFunctions.addSpatialPartToTimelines = function(aStartTime, aStartValues, aStartInEasing, aStartOutEasing, aEndTime, aEndValues, aEndInEasing, aEndOutEasing, aSpatialCurve, aPointProperties, aHasEasing, aReturnTimelines) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::addSpatialPartToTimelines");
	...
	staticFunctions.setStartValuesForTimelines = function(aValues, aReturnTimelines, aMultiplier) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::setStartValuesForTimelines");
	...
	staticFunctions._createTimelines = function(aReturnTimelines) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::_createTimelines");
	...
	staticFunctions._fillSpacialCurveWithValues = function(aStartPoint, aStartTangent, aEndPoint, aEndTangent, aPointsArray) {
		//console.log("dbm.adobeextendscript.aftereffects.utils.export.TimelineGenerator::_fillSpacialCurveWithValue");
