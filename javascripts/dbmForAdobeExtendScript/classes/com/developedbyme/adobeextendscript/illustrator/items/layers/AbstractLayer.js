...
dbm.registerClass("com.developedbyme.adobeextendscript.illustrator.items.layers.AbstractLayer", "com.developedbyme.adobeextendscript.illustrator.items.layers.LayerBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.adobeextendscript.illustrator.items.layers.AbstractLayer");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.adobeextendscript.illustrator.items.layers.AbstractLayer::_init");
	...
	staticFunctions.create = function(aNativeItem) {
		//console.log("com.developedbyme.adobeextendscript.illustrator.items.layers.AbstractLayer::create");
