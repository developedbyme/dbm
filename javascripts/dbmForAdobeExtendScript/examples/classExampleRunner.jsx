...
console.log = function(){
    ...
    $.writeln(joinArray.join.apply(arguments, [", "]));
};
...
console.warn = function(){
    ...
    $.writeln("WARNING: " + joinArray.join.apply(arguments, [", "]));
};
console.error = function(){
    var joinArray = new Array();
    
    $.writeln("ERROR: " + joinArray.join.apply(arguments, [", "]));
};
console.trace = function(){};

(function() {
    var javasciptsFolder = "/Library/WebServer/Documents/tests/dbm/javascripts";
    var classPath = "com.developedbyme.adobeextendscript.projects.tools.aftereffects.ExportActiveCompositionAnimationApplication";
    
    var importScript = function(aFilePath) {
        var dbmFile = new File(javasciptsFolder + "/" + aFilePath);
        dbmFile.open("r");
        var fullText = dbmFile.read();
        dbmFile.close();
        eval(fullText);
    };
    
    importScript("dbmForAdobeExtendScript/dbmForAdobeExtendScript.js")
    dbm = global.dbm;
    ...
    importScript("dbmForAdobeExtendScript/setup/defaultSetup.js");
