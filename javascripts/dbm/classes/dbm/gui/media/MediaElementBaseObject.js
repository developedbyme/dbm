...
dbm.registerClass("dbm.gui.media.MediaElementBaseObject", "dbm.gui.DisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.gui.media.MediaElementBaseObject");
	
	//Self reference
	var MediaElementBaseObject = dbm.importClass("dbm.gui.media.MediaElementBaseObject");
	...
	objectFunctions._init = function() {
		//console.log("dbm.gui.media.MediaElementBaseObject::_init");
	...
	objectFunctions.setUrls = function(aUrls, aPreload) {
		console.log("dbm.gui.media.MediaElementBaseObject::setUrls");
	...
	objectFunctions.setUrl = function(aUrl, aPreload) {
		console.log("dbm.gui.media.MediaElementBaseObject::setUrl");
	...
	objectFunctions.play = function() {
		console.log("dbm.gui.media.MediaElementBaseObject::play");
	...
	objectFunctions._performPlay = function() {
		console.log("dbm.gui.media.MediaElementBaseObject::_performPlay");
		try {
