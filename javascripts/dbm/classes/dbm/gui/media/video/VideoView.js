...
dbm.registerClass("dbm.gui.media.video.VideoView", "dbm.gui.media.MediaElementBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.gui.media.video.VideoView");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.gui.media.video.VideoView::_init");
	...
	staticFunctions.createFromAsset = function(aParentOrDocument, aAddToParent, aAssetPath, aAttributes) {
		//console.log("dbm.gui.media.video.VideoView::createFromAsset");
