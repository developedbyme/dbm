...
dbm.registerClass("dbm.gui.form.sliders.HorizontalScaleSlider", "dbm.gui.form.sliders.AbstractSlider", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.gui.form.sliders.HorizontalScaleSlider");
	...
	objectFunctions.activate = function() {
		//console.log("dbm.gui.form.sliders.HorizontalScaleSlider::activate");
		this.superCall();
	...
	objectFunctions._getCurrentScrubValue = function() {
		//console.log("dbm.gui.form.sliders.HorizontalScaleSlider::_getCurrentScrubValue");
