 ...
 */
dbm.registerClass("dbm.gui.buttons.FileUploadButton", "dbm.gui.buttons.BaseButton", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.gui.buttons.FileUploadButton");
	...
	objectFunctions._init = function() {
		//console.log("dbm.gui.buttons.FileUploadButton::_init");
	...
	objectFunctions._removeCurrentAsset = function() {
		console.log("dbm.gui.buttons.FileUploadButton::_removeCurrentAsset");
	...
	objectFunctions._createNewAsset = function(aFileReference, aReadMode) {
		console.log("dbm.gui.buttons.FileUploadButton::_createNewAsset");
	...
	objectFunctions._getReadModeForType = function(aType) {
		console.log("dbm.gui.buttons.FileUploadButton::_getReadModeForType");
		console.log(aType);
	...
	objectFunctions._setFileReference = function(aFileReference) {
		console.log("dbm.gui.buttons.FileUploadButton::_setFileReference");
	...
	objectFunctions._filesDropped = function(aFiles) {
		console.log("dbm.gui.buttons.FileUploadButton::_filesDropped");
		console.log(aFiles);
