...
dbm.registerClass("dbm.utils.speech.SpeechRecognitionProcessor", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.speech.SpeechRecognitionProcessor");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.speech.SpeechRecognitionProcessor::_init");
	...
	objectFunctions._speechRecognitionResult = function(aEvent) {
		console.log("dbm.utils.speech.SpeechRecognitionProcessor::_speechRecognitionResult");
		console.log(aEvent);
	};
	...
	objectFunctions.setAllReferencesToNull = function() {
		//console.log("dbm.utils.speech.SpeechRecognitionProcessor::setAllReferencesToNull");
