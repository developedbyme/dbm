...
dbm.registerClass("dbm.utils.file.BinaryStreamReader", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.file.BinaryStreamReader");
	
	var BinaryStreamReader = dbm.importClass("dbm.utils.file.BinaryStreamReader");
	
	objectFunctions._init = function() {
		//console.log("dbm.utils.file.BinaryStreamReader::_init");
	...
	objectFunctions.readData = function(aLength) {
		//console.log("dbm.utils.file.BinaryStreamReader::readData");
	...
	objectFunctions.readUtf8String = function(aLength) {
		//console.log("dbm.utils.file.BinaryStreamReader::readUtf8String");
