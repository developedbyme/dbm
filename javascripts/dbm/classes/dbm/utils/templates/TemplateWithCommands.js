 ...
 */
dbm.registerClass("dbm.utils.templates.TemplateWithCommands", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.templates.TemplateWithCommands");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.templates.TemplateWithCommands::_init");
	...
	objectFunctions.setTemplate = function(aTemplate) {
		//console.log("dbm.utils.templates.TemplateWithCommands::setTemplate");
	...
	objectFunctions.createNewItem = function(aData) {
		//console.log("dbm.utils.templates.TemplateWithCommands::createNewItem");
		//console.log(aData);
