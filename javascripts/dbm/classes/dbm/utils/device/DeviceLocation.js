...
dbm.registerClass("dbm.utils.device.DeviceLocation", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.device.DeviceLocation");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.device.DeviceLocation::_init");
	...
	objectFunctions._positionUpdated = function(aEvent) {
		//console.log("dbm.utils.device.DeviceLocation::_requestCallback");
		//console.log(aEvent);
	...
	objectFunctions._positionError = function(aEvent) {
		console.log("dbm.utils.device.DeviceLocation::_errorCallback");
		console.log(aEvent);
