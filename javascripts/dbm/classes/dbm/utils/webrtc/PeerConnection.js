...
dbm.registerClass("dbm.utils.webrtc.PeerConnection", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.webrtc.PeerConnection");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.webrtc.PeerConnection::_init");
	...
	objectFunctions.createNewOfferWhenNegotiationIsNeeded = function() {
		console.log("dbm.utils.webrtc.PeerConnection::createNewOfferWhenNegotiationIsNeeded");
	...
	objectFunctions.createDataChannel = function(aName) {
		console.log("dbm.utils.webrtc.PeerConnection::createDataChannel");
	...
	objectFunctions.addStream = function(aStream) {
		console.log("dbm.utils.webrtc.PeerConnection::addStream");
	...
	objectFunctions.addRemoteIceCandidate = function(aCandidate) {
		console.log("dbm.utils.webrtc.PeerConnection::addRemoteIceCandidate");
	...
	objectFunctions._callback_iceCandidateReceived = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_iceCandidateReceived");
	...
	objectFunctions._callback_streamAdded = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_streamAdded");
		
		//METODO
	};
	
	objectFunctions._callback_channelAdded = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_channelAdded");
		
		//METODO
	};
	
	objectFunctions._callback_streamRemoved = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_streamRemoved");
		
		//METODO
	};
	
	objectFunctions._callback_negotionationNeeded = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_negotionationNeeded");
		
		//METODO
	};
	
	objectFunctions._callback_iceConnectionChanged = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_iceConnectionChanged");
	...
	objectFunctions._callback_signalingStateChanged = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_signalingStateChanged");
	...
	objectFunctions.setLocalDescription = function(aDescription) {
		console.log("dbm.utils.webrtc.PeerConnection::setLocalDescription");
	...
	objectFunctions.setRemoteDescription = function(aDescription) {
		console.log("dbm.utils.webrtc.PeerConnection::setRemoteDescription");
		console.log(aDescription);
	...
	objectFunctions._callback_localDescriptionSet = function() {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_localDescriptionSet");
		
		//METODO
	};
	
	objectFunctions._callback_localDescriptionError = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_localDescriptionError");
		
		//METODO
	};
	
	objectFunctions._callback_remoteDescriptionSet = function() {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_remoteDescriptionSet");
		
		//METODO
	};
	
	objectFunctions._callback_remoteDescriptionError = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_remoteDescriptionError");
		
		//METODO
	};
	
	objectFunctions._callback_offerError = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_offerError");
		
		//METODO
	};
	
	objectFunctions._callback_answerError = function(aEvent) {
		console.log("dbm.utils.webrtc.PeerConnection::_callback_answerError");
	...
	staticFunctions.create = function() {
		console.log("dbm.utils.webrtc.PeerConnection::create");
