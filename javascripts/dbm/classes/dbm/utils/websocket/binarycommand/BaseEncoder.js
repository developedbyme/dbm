...
dbm.registerClass("dbm.utils.websocket.binarycommand.BaseEncoder", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.websocket.binarycommand.BaseEncoder");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.websocket.binarycommand.BaseEncoder::_init");
	...
	objectFunctions.encode = function(aEncodingData) {
		//console.log("dbm.utils.websocket.binarycommand.BaseEncoder::encode");
