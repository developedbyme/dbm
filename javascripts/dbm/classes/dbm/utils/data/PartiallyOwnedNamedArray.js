...
dbm.registerClass("dbm.utils.data.PartiallyOwnedNamedArray", "dbm.utils.data.NamedArray", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.PartiallyOwnedNamedArray");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.PartiallyOwnedNamedArray::_init");
