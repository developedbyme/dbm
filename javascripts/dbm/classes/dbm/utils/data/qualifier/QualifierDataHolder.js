 ...
 * @version	0.0.01
 */
dbm.registerClass("dbm.utils.data.qualifier.QualifierDataHolder", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.qualifier.QualifierDataHolder");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.qualifier.QualifierDataHolder::_init");
