...
dbm.registerClass("dbm.utils.data.storage.database.IndexedDatabase", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.storage.database.IndexedDatabase");
	//"use strict";
	
	var IndexedDatabase = dbm.importClass("dbm.utils.data.storage.database.IndexedDatabase");
	
	var IndexedDatabaseOperation = dbm.importClass("dbm.utils.data.storage.database.IndexedDatabaseOperation");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.storage.database.IndexedDatabase::_init");
	...
	objectFunctions._openRequestBlocked = function(aEvent) {
		console.log("dbm.utils.data.storage.database.IndexedDatabase::_openRequestBlocked");
	};
	
	objectFunctions._openRequestNeedsUpgrade = function(aEvent) {
		console.log("dbm.utils.data.storage.database.IndexedDatabase::_openRequestNeedsUpgrade");
	...
	objectFunctions._openRequestSuccess = function(aEvent) {
		console.log("dbm.utils.data.storage.database.IndexedDatabase::_openRequestSuccess");
	...
	objectFunctions._databaseAbort = function(aEvent) {
		console.log("dbm.utils.data.storage.database.IndexedDatabase::_databaseAbort");
	};
	
	objectFunctions._databaseError = function(aEvent) {
		console.log("dbm.utils.data.storage.database.IndexedDatabase::_databaseError");
	};
	
	objectFunctions._databaseVersionChange = function(aEvent) {
		console.log("dbm.utils.data.storage.database.IndexedDatabase::_databaseVersionChange");
	};
	...
	objectFunctions.selectRangeFromTable = function(aTableName, aLowerLimit, aUpperLimit, aOpenLower, aOpenUpper) {
		console.log("dbm.utils.data.storage.database.IndexedDatabase::selectRangeFromTable");
	...
	staticFunctions.create = function(aName, aStructure, aVersion) {
		//console.log("dbm.utils.data.IndexedDatabase.create");
