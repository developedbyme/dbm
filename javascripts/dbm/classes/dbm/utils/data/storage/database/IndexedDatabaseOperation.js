...
dbm.registerClass("dbm.utils.data.storage.database.IndexedDatabaseOperation", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.storage.database.IndexedDatabaseOperation");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.storage.database.IndexedDatabaseOperation::_init");
	...
	objectFunctions._successCallback = function(aEvent) {
		console.log("dbm.utils.data.storage.database.IndexedDatabaseOperation::_successCallback");
	...
	objectFunctions._errorCallback = function(aEvent) {
		console.log("dbm.utils.data.storage.database.IndexedDatabaseOperation::_errorCallback");
		
		this._status = -1;
	};
	
	objectFunctions._completeCallback = function(aEvent) {
		console.log("dbm.utils.data.storage.database.IndexedDatabaseOperation::_completeCallback");
	...
	staticFunctions.create = function(aTransaction) {
		//console.log("dbm.utils.data.IndexedDatabaseOperation.create");
