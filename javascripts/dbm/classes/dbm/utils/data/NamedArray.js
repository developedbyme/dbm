 ...
 */
dbm.registerClass("dbm.utils.data.NamedArray", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.NamedArray");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.NamedArray::_init");
	...
	objectFunctions.getObject = function(aName) {
		//console.log("dbm.utils.data.NamedArray::getObject");
