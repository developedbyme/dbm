 ...
 */
dbm.registerClass("dbm.utils.data.ArrayHolder", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.ArrayHolder");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.ArrayHolder::_init");
