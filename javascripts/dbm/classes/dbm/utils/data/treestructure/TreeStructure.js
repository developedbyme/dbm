 ...
 * A tree structure.
 */
dbm.registerClass("dbm.utils.data.treestructure.TreeStructure", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.treestructure.TreeStructure");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.treestructure.TreeStructure::_init");
	...
	objectFunctions.getItemByPath = function(aPath, aBaseItem) {
		//console.log("dbm.utils.data.treestructure.TreeStructure::getItemByPath");
	...
	staticFunctions.create = function() {
		//console.log("dbm.utils.data.treestructure.TreeStructure::create");
