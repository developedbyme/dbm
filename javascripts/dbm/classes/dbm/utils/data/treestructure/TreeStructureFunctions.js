 ...
 */
dbm.registerClass("dbm.utils.data.treestructure.TreeStructureFunctions", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.treestructure.TreeStructureFunctions");
	//"use strict";
	...
	staticFunctions.getItemsByAttribute = function(aTreeStructureItems, aAttributeName, aMatchValue, aReturnArray) {
		//console.log("dbm.utils.data.treestructure.TreeStructureFunctions::getItemsByAttribute");
	...
	staticFunctions.getItemsWithoutAttribute = function(aTreeStructureItems, aAttributeName, aReturnArray) {
		//console.log("dbm.utils.data.treestructure.TreeStructureFunctions::getItemsWithoutAttribute");
