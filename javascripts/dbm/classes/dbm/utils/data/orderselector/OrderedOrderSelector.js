...
dbm.registerClass("dbm.utils.data.orderselector.OrderedOrderSelector", "dbm.utils.data.orderselector.OrderSelectorBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.orderselector.OrderedOrderSelector");
	//"use strict";
	
	var OrderedOrderSelector = dbm.importClass("dbm.utils.data.orderselector.OrderedOrderSelector");
	
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.orderselector.OrderedOrderSelector::_init");
