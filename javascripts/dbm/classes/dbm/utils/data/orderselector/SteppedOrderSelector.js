...
dbm.registerClass("dbm.utils.data.orderselector.SteppedOrderSelector", "dbm.utils.data.orderselector.OrderSelectorBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.orderselector.SteppedOrderSelector");
	//"use strict";
	
	var SteppedOrderSelector = dbm.importClass("dbm.utils.data.orderselector.SteppedOrderSelector");
	
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.orderselector.SteppedOrderSelector::_init");
	...
	objectFunctions.getNextValue = function(aReservedData) {
		//console.log("dbm.utils.data.orderselector.SteppedOrderSelector::getNextValue");
