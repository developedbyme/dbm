...
dbm.registerClass("dbm.utils.data.KeyValuePropertyArray", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.KeyValuePropertyArray");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.KeyValuePropertyArray::_init");
	...
	objectFunctions._updateNamesArray = function(aFlowUpdateNumber) {
		//console.log("dbm.utils.data.KeyValuePropertyArray::_getObjectIndexByName");
	...
	objectFunctions.getObject = function(aName) {
		//console.log("dbm.utils.data.KeyValuePropertyArray::getObject");
		var currentIndex = this._getObjectIndexByName(aName);
		if(currentIndex === -1) {
