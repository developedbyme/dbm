...
/**
 * Data for running an iteration.
 */
dbm.registerClass("dbm.utils.data.iterator.IterationData", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.data.iterator.IterationData");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.data.iterator.ActiveIterationData::_init");
