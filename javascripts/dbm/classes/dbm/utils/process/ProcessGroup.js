...
dbm.registerClass("dbm.utils.process.ProcessGroup", "dbm.utils.process.ProcessObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.process.ProcessGroup");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.process.ProcessGroup::_init");
	...
	objectFunctions._performStartProcess = function() {
		//console.log("dbm.utils.process.ProcessGroup::_performStartProcess");
	...
	objectFunctions._updateDoneFlow = function(aFlowUpdateNumber) {
		//console.log("dbm.utils.process.ProcessGroup::_updateDoneFlow");
