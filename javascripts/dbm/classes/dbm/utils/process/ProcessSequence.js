...
dbm.registerClass("dbm.utils.process.ProcessSequence", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.process.ProcessSequence");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.process.ProcessSequence::_init");
	...
	objectFunctions.startProcess = function() {
		//console.log("dbm.utils.process.ProcessSequence::startProcess");
	...
	objectFunctions._startWaitingProcess = function(aProcess) {
		//console.log("dbm.utils.process.ProcessSequence::_startWaitingProcess");
	...
	objectFunctions._continueProcess = function() {
		//console.log("dbm.utils.process.ProcessSequence::_continueProcess");
	...
	objectFunctions._processDone = function(aProcess) {
		//console.log("dbm.utils.process.ProcessSequence::_processDone");
	...
	objectFunctions._updateProgressFlow = function(aFlowUpdateNumber) {
		//console.log("dbm.utils.process.ProcessSequence::_updateProgressFlow");
