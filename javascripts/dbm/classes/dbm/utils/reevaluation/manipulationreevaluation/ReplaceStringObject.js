 ...
 */
dbm.registerClass("dbm.utils.reevaluation.manipulationreevaluation.ReplaceStringObject", "dbm.utils.reevaluation.ReevaluationBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.reevaluation.manipulationreevaluation.ReplaceStringObject::_init");
	...
	objectFunctions.reevaluate = function(aBaseObject) {
		//console.log("dbm.utils.reevaluation.manipulationreevaluation.ReplaceStringObject::reevaluate");
	...
	staticFunctions.createCommand = function(aString, aOldValue, aNewValue) {
		//console.log("dbm.utils.reevaluation.manipulationreevaluation.ReplaceStringObject::createCommand (static)");
