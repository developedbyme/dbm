...
dbm.registerClass("dbm.utils.reevaluation.logicreevaluation.ConditionAnyOfMultipleValuesObject", "dbm.utils.reevaluation.ReevaluationBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.reevaluation.logicreevaluation.ConditionAnyOfMultipleValuesObject::_init");
	...
	objectFunctions.reevaluate = function(aBaseObject) {
		//console.log("dbm.utils.reevaluation.logicreevaluation.ConditionAnyOfMultipleValuesObject::reevaluate");
	...
	staticFunctions.createCommand = function(aInputValue, aConditionType, aMatchedValues) {
		//console.log("dbm.utils.reevaluation.logicreevaluation.ConditionAnyOfMultipleValuesObject::createCommand (static)");
