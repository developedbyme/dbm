...
dbm.registerClass("dbm.utils.reevaluation.objectreevaluation.GetPropertyValueObject", "dbm.utils.reevaluation.objectreevaluation.ObjectReevaluationBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.reevaluation.objectreevaluation.GetPropertyValueObject::_init");
	...
	objectFunctions.reevaluate = function(aBaseObject) {
		//console.log("dbm.utils.reevaluation.objectreevaluation.GetPropertyValueObject::reevaluate");
	...
	staticFunctions.createCommand = function(aObject, aPropertyName) {
		//console.log("dbm.utils.reevaluation.objectreevaluation.GetPropertyValueObject::createCommand (static)");
