 ...
 */
dbm.registerClass("dbm.utils.reevaluation.objectreevaluation.ObjectReevaluationBaseObject", "dbm.utils.reevaluation.ReevaluationBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.reevaluation.objectreevaluation.ObjectReevaluationBaseObject");
	
	//Self reference
	var ObjectReevaluationBaseObject = dbm.importClass("dbm.utils.reevaluation.objectreevaluation.ObjectReevaluationBaseObject");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.reevaluation.objectreevaluation.ObjectReevaluationBaseObject::_init");
