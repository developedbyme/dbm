 ...
 */
dbm.registerClass("dbm.utils.reevaluation.objectreevaluation.GetNamedArrayValueObject", "dbm.utils.reevaluation.objectreevaluation.ObjectReevaluationBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.reevaluation.objectreevaluation.GetNamedArrayValueObject::_init");
	...
	objectFunctions.reevaluate = function(aBaseObject) {
		//console.log("dbm.utils.reevaluation.objectreevaluation.GetNamedArrayValueObject::reevaluate");
		//console.log(this);
	...
	staticFunctions.createCommand = function(aObject, aName) {
		//console.log("dbm.utils.reevaluation.objectreevaluation.GetNamedArrayValueObject::createCommand (static)");
		//console.log(aName);
