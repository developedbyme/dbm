...
dbm.registerClass("dbm.utils.reevaluation.objectreevaluation.GetPropertyObject", "dbm.utils.reevaluation.objectreevaluation.ObjectReevaluationBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.reevaluation.objectreevaluation.GetPropertyObject::_init");
	...
	objectFunctions.reevaluate = function(aBaseObject) {
		//console.log("dbm.utils.reevaluation.objectreevaluation.GetPropertyObject::reevaluate");
		//console.log(this);
	...
	staticFunctions.createCommand = function(aObject, aPropertyName) {
		//console.log("dbm.utils.reevaluation.objectreevaluation.GetPropertyObject::createCommand (static)");
