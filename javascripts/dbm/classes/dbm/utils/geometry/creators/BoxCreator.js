...
dbm.registerClass("dbm.utils.geometry.creators.BoxCreator", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.geometry.creators.BoxCreator");
	
	var BoxCreator = dbm.importClass("dbm.utils.geometry.creators.BoxCreator");
