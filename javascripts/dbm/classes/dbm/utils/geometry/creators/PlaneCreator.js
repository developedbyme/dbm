...
dbm.registerClass("dbm.utils.geometry.creators.PlaneCreator", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.geometry.creators.PlaneCreator");
	...
	staticFunctions.createPlane = function(aMesh, aPoint, aHorizontalVector, aVerticalVector, aSectionsHorizontal, aSectionsVertical, aUvPoint, aUvHorizontalVector, aUvVerticalVector) {
		console.log("dbm.utils.geometry.creators.PlaneCreator::createPlane");
