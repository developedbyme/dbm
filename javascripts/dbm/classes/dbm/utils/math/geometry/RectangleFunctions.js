 ...
 */
dbm.registerClass("dbm.utils.math.geometry.RectangleFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.math.geometry.RectangleFunctions");
