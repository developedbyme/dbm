...
dbm.registerClass("dbm.utils.math.music.NoteLengths", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.math.music.NoteLengths");
	...
	staticFunctions.tupletLength = function(aNumberOfNotes, aPlayedOverNumberOfNotes, aNoteLength) {
		console.log("dbm.utils.math.music.NoteLengths::tupletLength");
