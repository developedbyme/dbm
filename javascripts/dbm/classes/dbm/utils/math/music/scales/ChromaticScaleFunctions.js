...
dbm.registerClass("dbm.utils.math.music.scales.ChromaticScaleFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.math.music.scales.ChromaticScaleFunctions");
