...
dbm.registerClass("dbm.utils.math.MatrixFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.math.MatrixFunctions");
