...
dbm.registerClass("dbm.utils.math.interpolation.OffsettedInterpolation", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.math.interpolation.OffsettedInterpolation");
	...
	staticFunctions.create = function(aInterpolationObject, aMultiplier, aOffset) {
		//console.log("dbm.utils.math.interpolation.OffsettedInterpolation::create");
