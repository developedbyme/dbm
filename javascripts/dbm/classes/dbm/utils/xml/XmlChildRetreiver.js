...
dbm.registerClass("dbm.utils.xml.XmlChildRetreiver", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.xml.XmlChildRetreiver");
	...
	staticFunctions.getNamespacedChild = function(aXml, aChildNamespace, aChildName) {
		//console.log("dbm.utils.xml.XmlChildRetreiver::getNamespacedChild (static)");
	...
	staticFunctions.getChilds = function(aXml, aChildName) {
		//console.log("dbm.utils.xml.XmlChildRetreiver::getChilds (static)");
	...
	staticFunctions.getNamespacedChildByNamespacedAttribute = function(aXml, aAttributeNamespace, aAttributeName, aValue, aChildNamespace, aChildName) {
		//console.log("dbm.utils.xml.XmlChildRetreiver::getNamespacedChildByNamespacedAttribute (static)");
	...
	staticFunctions.getFirstTextNode = function(aXml) {
		//console.log("dbm.utils.xml.XmlChildRetreiver::getTextNode (static)");
	...
	staticFunctions.getAllValuesForAttribute = function(aXml, aAttributeName, aReturnArray) {
		//console.log("dbm.utils.xml.XmlChildRetreiver::getAllValuesForAttribute (static)");
