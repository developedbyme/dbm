...
dbm.registerClass("dbm.utils.xml.DbmXmlEncoder", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.xml.DbmXmlEncoder");
	...
	staticFunctions.encodeXmlFromObject = function(aObject) {
		//console.log("dbm.utils.xml.DbmXmlEncoder::encodeXmlFromObject");
	...
	staticFunctions._createDataNode = function(aType, aParentNode) {
		//console.log("dbm.utils.xml.DbmXmlEncoder::_createDataNode");
	...
	staticFunctions.encodeValue = function(aValue, aParentNode) {
		//console.log("dbm.utils.xml.DbmXmlEncoder::encodeValue");
		var newXml = XmlCreator.createEmptyXml();
	...
	staticFunctions.encodeObject = function(aValue, aParentNode) {
		//console.log("dbm.utils.xml.DbmXmlEncoder::encodeObject");
