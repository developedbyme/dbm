...
dbm.registerClass("dbm.utils.authorization.OauthFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.authorization.OauthFunctions");
	...
	var StringEncodingFunctions = dbm.importClass("dbm.utils.native.string.StringEncodingFunctions");
	var NonceGenerator = dbm.importClass("dbm.utils.random.NonceGenerator");
	...
	staticFunctions.createHeader = function(aParametersObject, aSignature) {
		console.log("dbm.utils.authorization.OauthFunctions::createHeader");
	...
	staticFunctions.createOauthParametersObject = function(aConsumerKey, aToken, aSignatureMethod, aVersion, aNonce, aTimestamp) {
		console.log("dbm.utils.authorization.OauthFunctions::createOauthParametersObject");
	...
	staticFunctions.createParametersString = function(aParameters, aOauthParameters) {
		console.log("dbm.utils.authorization.OauthFunctions::createParametersString");
	...
	staticFunctions.createSignatureBaseString = function(aMethod, aUrl, aParametersString) {
		console.log("dbm.utils.authorization.OauthFunctions::createSignatureBaseString");
