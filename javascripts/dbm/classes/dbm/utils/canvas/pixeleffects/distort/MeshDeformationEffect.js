 ...
 */
dbm.registerClass("dbm.utils.canvas.pixeleffects.distort.MeshDeformationEffect", "dbm.utils.canvas.pixeleffects.PixelEffectBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.pixeleffects.distort.MeshDeformationEffect");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.canvas.pixeleffects.distort.MeshDeformationEffect::_init");
	...
	objectFunctions.applyEffect = function(aInputGraphics, aOutputGraphics, aWidth, aHeight, aOffsetX, aOffsetY) {
		//console.log("dbm.utils.canvas.pixeleffects.distort.MeshDeformationEffect::applyEffect");
	...
	objectFunctions._getFirstIntersection = function(aIntersections, aMinParameter) {
		//console.log("dbm.utils.canvas.pixeleffects.distort.MeshDeformationEffect::_getFirstIntersection");
	...
	objectFunctions._getLineScanBorderIntersection = function(aLinePoint, aLineVector, aMesh, aStartX, aStartY, aEndX, aEndY, aReturnArray) {
		//console.log("dbm.utils.canvas.pixeleffects.distort.MeshDeformationEffect::_getLineScanBorderIntersection");
