 ...
 */
dbm.registerClass("dbm.utils.canvas.pixeleffects.distort.PolarCoordinatesEffect", "dbm.utils.canvas.pixeleffects.PixelEffectBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.pixeleffects.distort.PolarCoordinatesEffect");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.canvas.pixeleffects.distort.PolarCoordinatesEffect::_init");
	...
	objectFunctions.applyEffect = function(aInputGraphics, aOutputGraphics, aWidth, aHeight, aOffsetX, aOffsetY) {
		//console.log("dbm.utils.canvas.pixeleffects.distort.PolarCoordinatesEffect::applyEffect");
