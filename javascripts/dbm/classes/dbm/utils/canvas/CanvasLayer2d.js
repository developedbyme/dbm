 ...
 */
dbm.registerClass("dbm.utils.canvas.CanvasLayer2d", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.CanvasLayer2d");
	...
	var CanvasTextGraphics2d = dbm.importClass("dbm.utils.canvas.CanvasTextGraphics2d");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.canvas.CanvasLayer2d::_init");
		...
		this._render = this.createProperty("render", true);
		...
		this._graphicsUpdate.connectInput(this._render);
	...
	objectFunctions.getMask = function() {
		//console.log("dbm.utils.canvas.CanvasLayer2d::getMask");
		if(this._mask === null) {
	...
	objectFunctions.setMaskUsage = function(aUse) {
		//console.log("dbm.utils.canvas.CanvasLayer2d::setMaskUsage");
	...
	objectFunctions._linkRegistration_setTransformationNode = function(aTransformationNode) {
		//console.log("dbm.utils.canvas.CanvasLayer2d::_linkRegistration_setTransformationNode");
	...
	objectFunctions.draw = function(aContext, aNumberOfLinksToResolve) {
		//console.log("dbm.utils.canvas.CanvasLayer2d::draw");
		//console.log(this);
	...
	objectFunctions._drawGraphics = function(aContext) {
		//console.log("dbm.utils.canvas.CanvasLayer2d::_drawGraphics");
	...
	objectFunctions._getCurrentDrawingLayer = function() {
		//console.log("dbm.utils.canvas.CanvasLayer2d::_getCurrentDrawingLayer");
	...
	objectFunctions._createNewDrawingLayer = function() {
		//console.log("dbm.utils.canvas.CanvasLayer2d::_createNewDrawingLayer");
	...
	objectFunctions.setStrokeStyle = function(aLineWidth, aStyle, aLineCap, aLineJoin, aMiterLimit) {
		//console.log("dbm.utils.canvas.CanvasLayer2d::setStrokeStyle");
		var currentDrawingLayer = this._getCurrentDrawingLayer();
		if(currentDrawingLayer.hasCurves()) {
			currentDrawingLayer = this._createNewDrawingLayer();
		}
	...
	objectFunctions.lineTo = function(aX, aY) {
		//console.log("dbm.utils.canvas.CanvasLayer2d::lineTo");
		var currentDrawingLayer = this._getCurrentDrawingLayer();
	...
	objectFunctions.drawText = function(aText) {
		//console.log("dbm.utils.canvas.CanvasLayer2d::drawText");
	...
	objectFunctions.addDrawingPart = function(aPart) {
		//console.log("dbm.utils.canvas.CanvasLayer2d::addDrawingPart");
	...
	objectFunctions.drawTextWithCustomSpacing = function(aText, aSpacing) {
		//console.log("dbm.utils.canvas.CanvasLayer2d::drawTextWithCustomSpacing");
