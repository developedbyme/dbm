 ...
 */
dbm.registerClass("dbm.utils.canvas.CanvasImageGraphics2d", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.CanvasImageGraphics2d");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.canvas.CanvasImageGraphics2d::_init");
	...
	objectFunctions.draw = function(aContext) {
		//console.log("dbm.utils.canvas.CanvasImageGraphics2d::draw");
	...
	staticFunctions.createConnectedImage = function(aImageProperty, aWidth, aHeight) {
		//console.log("dbm.utils.canvas.CanvasImageGraphics2d::createConnectedImage");
