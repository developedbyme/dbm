 ...
 */
dbm.registerClass("dbm.utils.canvas.CanvasGraphics2d", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.CanvasGraphics2d");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.canvas.CanvasGraphics2d::_init");
	...
	objectFunctions._strokePath = function(aContext, aStyle) {
		//console.log("dbm.utils.canvas.CanvasGraphics2d::_strokePath");
	...
	objectFunctions.draw = function(aContext) {
		//console.log("dbm.utils.canvas.CanvasGraphics2d::draw");
