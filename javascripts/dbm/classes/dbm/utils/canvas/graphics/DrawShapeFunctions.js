 ...
 */
dbm.registerClass("dbm.utils.canvas.graphics.DrawShapeFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.graphics.DrawShapeFunctions");
	...
	staticFunctions.drawCircle = function(aLayer, aX, aY, aRadius, aLineWidth, aStrokeStyle, aFillStyle) {
		//console.log("dbm.utils.canvas.graphics.DrawShapeFunctions::drawCircle");
