...
dbm.registerClass("dbm.utils.canvas.CanvasTextGraphics2d", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.CanvasTextGraphics2d");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.canvas.CanvasTextGraphics2d::_init");
