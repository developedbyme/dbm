...
dbm.registerClass("dbm.utils.canvas.3d.Model3d", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.3d.Model3d");
	
	var Model3d = dbm.importClass("dbm.utils.canvas.3d.Model3d");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.canvas.3d.Model3d::_init");
	...
	objectFunctions.createLink = function(aFrom, aTo) {
		//console.log("dbm.utils.canvas.3d.Model3d::createLink");
