 ...
 */
dbm.registerClass("dbm.utils.canvas.3d.CanvasController3d", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.3d.CanvasController3d");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.canvas.3d.CanvasController3d::_init");
	...
	objectFunctions.createLink = function(aFrom, aTo) {
		//console.log("dbm.utils.canvas.3d.CanvasController3d::createLink");
	...
	objectFunctions._getContext = function(aCanvas) {
		//console.log("dbm.utils.canvas.3d.CanvasController3d::_getContext");
		//console.log(aCanvas);
	...
	objectFunctions.draw = function() {
		//console.log("dbm.utils.canvas.3d.CanvasController3d::draw");
	...
	objectFunctions._updateFlow = function(aFlowUpdateNumber) {
		//console.log("dbm.utils.canvas.3d.CanvasController3d::_updateFlow");
		this.draw();
	};
