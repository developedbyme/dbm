...
dbm.registerClass("dbm.utils.canvas.3d.drawcommands.SetTransformationMatrixCommand", "dbm.utils.canvas.3d.drawcommands.BaseDrawCommand", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.canvas.3d.drawcommands.SetTransformationMatrixCommand");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.canvas.3d.drawcommands.SetTransformationMatrixCommand::_init");
	...
	objectFunctions.draw = function(aContext, aProjectionMatrix, aTransformationMatrix) {
		//console.log("dbm.utils.canvas.3d.drawcommands.SetTransformationMatrixCommand::draw");
