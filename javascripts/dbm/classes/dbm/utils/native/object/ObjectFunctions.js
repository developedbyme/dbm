...
dbm.registerClass("dbm.utils.native.object.ObjectFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.native.object.ObjectFunctions");
	...
	staticFunctions.typeOfValue = function(aValue) {
		//console.log("dbm.utils.native.object.ObjectFunctions::typeOfValue");
		//console.log(aValue);
	...
	staticFunctions.convertValueToType = function(aValue, aType) {
		//console.log("dbm.utils.native.object.ObjectFunctions::convertValueToType");
