...
dbm.registerClass("dbm.utils.native.string.UrlFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.native.string.UrlFunctions");
	//"use strict";
