...
dbm.registerClass("dbm.utils.native.string.JavascriptLanguageFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.native.string.JavascriptLanguageFunctions");
	//"use strict";
