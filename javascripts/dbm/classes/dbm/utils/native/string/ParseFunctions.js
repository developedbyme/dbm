...
dbm.registerClass("dbm.utils.native.string.ParseFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.native.string.ParseFunctions");
	//"use strict";
