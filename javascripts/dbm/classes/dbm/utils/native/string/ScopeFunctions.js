...
dbm.registerClass("dbm.utils.native.string.ScopeFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.native.string.ScopeFunctions");
	//"use strict";
	...
	staticFunctions.getScopeStart = function(aText, aFromPosition, aScopeStarts) {
		//console.log("dbm.utils.native.string.ScopeFunctions::getScopeStart");
	...
	staticFunctions.splitEvaluation = function(aText, aReturnOperators) {
		//console.log("dbm.utils.native.string.ScopeFunctions::splitEvaluation");
	...
	staticFunctions.getTypeOfScopeStart = function(aText, aPosition, aScopeStarts) {
		//console.log("dbm.utils.native.string.ScopeFunctions::getTypeOfScopeStart");
	...
	staticFunctions.getTypeOfScopeEndForScopeStart = function(aStart, aScopeStarts, aScopeEnds) {
		//console.log("dbm.utils.native.string.ScopeFunctions::getTypeOfScopeEndForScopeStart");
	...
	staticFunctions.getAnyScope = function(aText, aStartPosition, aStartType, aEndType, aScopeStarts, aScopeEnds) {
		//console.log("dbm.utils.native.string.ScopeFunctions::getAnyScope");
	...
	staticFunctions.getScope = function(aText, aStartPosition, aStartType, aEndType, aScopeStarts, aScopeEnds) {
		//console.log("dbm.utils.native.string.ScopeFunctions::getScope");
