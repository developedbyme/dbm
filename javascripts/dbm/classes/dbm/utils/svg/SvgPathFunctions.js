...
dbm.registerClass("dbm.utils.svg.SvgPathFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.svg.SvgPathFunctions");
	//"use strict";
