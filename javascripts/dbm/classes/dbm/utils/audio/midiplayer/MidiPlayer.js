...
dbm.registerClass("dbm.utils.audio.midiplayer.MidiPlayer", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.audio.midiplayer.MidiPlayer");
	...
	var CommandTimerNode = dbm.importClass("dbm.flow.nodes.animation.CommandTimerNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.audio.midiplayer.MidiPlayer::_init");
	...
	objectFunctions.addTrack = function(aTrack, aTicksPerQuarterNote) {
		console.log("dbm.utils.audio.midiplayer.MidiPlayer::addTrack");
	...
	objectFunctions.setAllReferencesToNull = function() {
		//console.log("dbm.utils.audio.midiplayer.MidiPlayer::setAllReferencesToNull");
