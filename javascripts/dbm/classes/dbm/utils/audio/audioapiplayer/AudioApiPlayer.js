...
dbm.registerClass("dbm.utils.audio.audioapiplayer.AudioApiPlayer", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.utils.audio.audioapiplayer.AudioApiPlayer");
	...
	objectFunctions._init = function() {
		//console.log("dbm.utils.audio.audioapiplayer.AudioApiPlayer::_init");
	...
	objectFunctions.updateTime = function(aTime, aFrame) {
		//console.log("dbm.utils.audio.audioapiplayer.AudioApiPlayer::updateTime");
	...
	objectFunctions.setAllReferencesToNull = function() {
		//console.log("dbm.utils.audio.audioapiplayer.AudioApiPlayer::setAllReferencesToNull");
