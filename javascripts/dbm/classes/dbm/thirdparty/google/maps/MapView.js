...
dbm.registerClass("dbm.thirdparty.google.maps.MapView", "dbm.gui.DisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._init = function() {
		//console.log("dbm.thirdparty.google.maps.MapView::_init");
	...
	objectFunctions.createDisplay = function() {
		console.log("dbm.thirdparty.google.maps.MapView::createDisplay");
