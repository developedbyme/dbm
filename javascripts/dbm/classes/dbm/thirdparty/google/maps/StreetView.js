...
dbm.registerClass("dbm.thirdparty.google.maps.StreetView", "dbm.gui.DisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._init = function() {
		//console.log("dbm.thirdparty.google.maps.StreetView::_init");
	...
	objectFunctions.createDisplay = function() {
		console.log("dbm.thirdparty.google.maps.StreetView::createDisplay");
