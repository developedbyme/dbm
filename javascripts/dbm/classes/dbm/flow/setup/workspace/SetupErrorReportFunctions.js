...
dbm.registerClass("dbm.flow.setup.workspace.SetupErrorReportFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.setup.workspace.SetupErrorReportFunctions");
	//"use strict";
