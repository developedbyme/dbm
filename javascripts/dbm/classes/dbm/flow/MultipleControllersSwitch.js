...
dbm.registerClass("dbm.flow.MultipleControllersSwitch", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.MultipleControllersSwitch");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.MultipleControllersSwitch::_init");
	...
	objectFunctions._updateFlow = function() {
		console.log("dbm.flow.MultipleControllersSwitch::_updateFlow");
	...
	staticFunctions.create = function(aInputOutputConnection) {
		//console.log("dbm.flow.MultipleControllersSwitch::create");
