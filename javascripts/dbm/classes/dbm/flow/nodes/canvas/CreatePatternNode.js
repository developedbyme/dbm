...
dbm.registerClass("dbm.flow.nodes.canvas.CreatePatternNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.canvas.CreatePatternNode");
	
	var CreatePatternNode = dbm.importClass("dbm.flow.nodes.canvas.CreatePatternNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.canvas.CreatePatternNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.canvas.CreatePatternNode::_update");
