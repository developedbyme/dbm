...
dbm.registerClass("dbm.flow.nodes.canvas.DrawElementWithScaleNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.canvas.DrawElementWithScaleNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.canvas.DrawElementWithScaleNode::_init");
	...
	staticFunctions.renderElement = function(aElement, aInputWidth, aInputHeight, aCanvas, aOutputWidth, aOutputHeight, aDataType, aQuality, aUpdate) {
		//console.log("dbm.flow.nodes.canvas.DrawElementWithScaleNode::renderElement");
