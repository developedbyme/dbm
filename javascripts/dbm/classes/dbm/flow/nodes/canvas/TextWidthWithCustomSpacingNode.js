...
dbm.registerClass("dbm.flow.nodes.canvas.TextWidthWithCustomSpacingNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.canvas.TextWidthWithCustomSpacingNode");
	
	var TextWidthWithCustomSpacingNode = dbm.importClass("dbm.flow.nodes.canvas.TextWidthWithCustomSpacingNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.canvas.TextWidthWithCustomSpacingNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.canvas.TextWidthWithCustomSpacingNode::_update");
