...
dbm.registerClass("dbm.flow.nodes.canvas.TextWidthNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.canvas.TextWidthNode");
	
	var TextWidthNode = dbm.importClass("dbm.flow.nodes.canvas.TextWidthNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.canvas.TextWidthNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.canvas.TextWidthNode::_update");
