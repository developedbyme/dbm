...
dbm.registerClass("dbm.flow.nodes.canvas.webgl.CreateTextureNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.canvas.webgl.CreateTextureNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.canvas.webgl.CreateTextureNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.canvas.webgl.CreateTextureNode::_update");
