...
dbm.registerClass("dbm.flow.nodes.canvas.DrawElementNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.canvas.DrawElementNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.canvas.DrawElementNode::_init");
	...
	staticFunctions.renderElement = function(aElement, aCanvas, aDataType, aQuality, aUpdate) {
		//console.log("dbm.flow.nodes.canvas.DrawElementNode::renderElement");
