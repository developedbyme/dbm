...
dbm.registerClass("dbm.flow.nodes.data.CachedValueNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.data.CachedValueNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.data.CachedValueNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.CachedValueNode::_update");
	...
	objectFunctions._updateInput = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.CachedValueNode::_updateInput");
		
		this._buffer.setNewData(this._inputValue.getValueWithoutFlow());
	};
	
	objectFunctions._updateLength = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.CachedValueNode::_updateLength");
