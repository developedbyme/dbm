...
dbm.registerClass("dbm.flow.nodes.curves.GetTangentOnCurveNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.curves.GetTangentOnCurveNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.curves.GetTangentOnCurveNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.curves.GetTangentOnCurveNode::_update");
