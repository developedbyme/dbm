...
dbm.registerClass("dbm.flow.nodes.curves.CreateLineFromCenterNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.curves.CreateLineFromCenterNode");
	
	//Self reference
	var CreateLineFromCenterNode = dbm.importClass("dbm.flow.nodes.curves.CreateLineFromCenterNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.curves.CreateLineFromCenterNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.curves.CreateLineFromCenterNode::_update");
		//console.log(this);
		
		var x = this._x.getValueWithoutFlow();
		var y = this._y.getValueWithoutFlow();
		var halfLength = 0.5*this._length.getValueWithoutFlow();
		...
		startPoint.x = x-halfLength*cosValue;
		startPoint.y = y-halfLength*sinValue;
		endPoint.x = x+halfLength*cosValue;
		endPoint.y = y+halfLength*sinValue;
	...
	staticFunctions.create = function(aX, aY, aLength, aAngle) {
		//console.log("dbm.flow.nodes.curves.CreateLineFromCenterNode::create");
