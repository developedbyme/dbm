...
dbm.registerClass("dbm.flow.nodes.curves.CreateWedgeInBoxCurveNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.curves.CreateWedgeInBoxCurveNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.curves.CreateWedgeInBoxCurveNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.curves.CreateWedgeInBoxCurveNode::_update");
		//console.log(this);
	...
	staticFunctions.create = function(aX, aY, aPivotX, aPivotY, aStartAngle, aEndAngle, aWidth, aHeight) {
		//console.log("dbm.flow.nodes.curves.CreateWedgeInBoxCurveNode::create");
