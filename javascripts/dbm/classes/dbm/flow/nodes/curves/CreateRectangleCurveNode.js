...
dbm.registerClass("dbm.flow.nodes.curves.CreateRectangleCurveNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.curves.CreateRectangleCurveNode");
	
	//Self reference
	var CreateRectangleCurveNode = dbm.importClass("dbm.flow.nodes.curves.CreateRectangleCurveNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.curves.CreateRectangleCurveNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.curves.CreateRectangleCurveNode::_update");
		//console.log(this);
	...
	staticFunctions.create = function(aX, aY, aWidth, aHeight) {
		//console.log("dbm.flow.nodes.curves.CreateRectangleCurveNode::create");
