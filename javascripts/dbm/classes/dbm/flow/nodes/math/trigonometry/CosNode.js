...
dbm.registerClass("dbm.flow.nodes.math.trigonometry.CosNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.trigonometry.CosNode");
	
	var CosNode = dbm.importClass("dbm.flow.nodes.math.trigonometry.CosNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.trigonometry.CosNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.trigonometry.CosNode::_update");
