...
dbm.registerClass("dbm.flow.nodes.math.range.RepeatedRangeNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions) {
	//console.log("dbm.flow.nodes.math.range.RepeatedRangeNode");
	
	var RepeatedRangeNode = dbm.importClass("dbm.flow.nodes.math.range.RepeatedRangeNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.range.RepeatedRangeNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.range.RepeatedRangeNode::_update");
