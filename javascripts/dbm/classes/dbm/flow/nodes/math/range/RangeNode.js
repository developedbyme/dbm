...
dbm.registerClass("dbm.flow.nodes.math.range.RangeNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.range.RangeNode");
	
	var RangeNode = dbm.importClass("dbm.flow.nodes.math.range.RangeNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.range.RangeNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.range.RangeNode::_update");
