...
dbm.registerClass("dbm.flow.nodes.math.SubtractionNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.SubtractionNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.SubtractionNode::_init");
	...
	staticFunctions._update = function(aInputValue1, aInputValue2) {
		//console.log("dbm.flow.nodes.math.SubtractionNode::_update");
