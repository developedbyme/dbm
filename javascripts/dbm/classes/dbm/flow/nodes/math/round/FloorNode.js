...
dbm.registerClass("dbm.flow.nodes.math.round.FloorNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.round.FloorNode");
	
	var FloorNode = dbm.importClass("dbm.flow.nodes.math.round.FloorNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.round.FloorNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.round.FloorNode::_update");
