...
dbm.registerClass("dbm.flow.nodes.math.round.RoundNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.round.RoundNode");
	
	var RoundNode = dbm.importClass("dbm.flow.nodes.math.round.RoundNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.round.RoundNode::_init");
