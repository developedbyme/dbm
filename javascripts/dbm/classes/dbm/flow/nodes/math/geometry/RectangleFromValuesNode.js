...
dbm.registerClass("dbm.flow.nodes.math.geometry.RectangleFromValuesNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.geometry.RectangleFromValuesNode");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.geometry.RectangleFromValuesNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.geometry.RectangleFromValuesNode::_update");
