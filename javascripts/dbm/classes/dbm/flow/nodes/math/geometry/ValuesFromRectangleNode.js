...
dbm.registerClass("dbm.flow.nodes.math.geometry.ValuesFromRectangleNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.geometry.ValuesFromRectangleNode");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.geometry.ValuesFromRectangleNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.geometry.ValuesFromRectangleNode::_update");
