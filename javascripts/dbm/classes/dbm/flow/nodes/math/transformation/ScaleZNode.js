...
dbm.registerClass("dbm.flow.nodes.math.transformation.ScaleZNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.transformation.ScaleZNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.transformation.ScaleZNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.transformation.ScaleZNode::_update");
