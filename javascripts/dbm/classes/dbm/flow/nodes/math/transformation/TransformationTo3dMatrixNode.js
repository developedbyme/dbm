...
dbm.registerClass("dbm.flow.nodes.math.transformation.TransformationTo3dMatrixNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.transformation.TransformationTo3dMatrixNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.transformation.TransformationTo3dMatrixNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.math.transformation.TransformationTo3dMatrixNode::_update");
	...
	staticFunctions.create = function(aX, aY, aZ, aRotateX, aRotateY, aRotateZ, aScaleX, aScaleY, aScaleZ, aRotationOrder) {
		//console.log("dbm.flow.nodes.math.transformation.TransformationTo3dMatrixNode::create");
