...
dbm.registerClass("dbm.flow.nodes.math.CircularDistanceNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.math.CircularDistanceNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.math.CircularDistanceNode::_init");
	...
	staticFunctions._update = function(aInputValue, aBaseValue, aLength) {
		//console.log("dbm.flow.nodes.math.CircularDistanceNode::_update");
