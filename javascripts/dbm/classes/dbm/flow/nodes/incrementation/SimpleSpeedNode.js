...
dbm.registerClass("dbm.flow.nodes.incrementation.SimpleSpeedNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.incrementation.SimpleSpeedNode");
	
	var SimpleSpeedNode = dbm.importClass("dbm.flow.nodes.incrementation.SimpleSpeedNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.incrementation.SimpleSpeedNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.incrementation.SimpleSpeedNode::_update");
