...
dbm.registerClass("dbm.flow.nodes.browser.LayoutChangeNode", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.browser.LayoutChangeNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.browser.LayoutChangeNode::_init");
	...
	objectFunctions._documentUpdated = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.browser.LayoutChangeNode::_documentUpdated");
