...
dbm.registerClass("dbm.flow.nodes.animation.CommandTimerNode", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.animation.CommandTimerNode");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.animation.CommandTimerNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.animation.CommandTimerNode::_update");
