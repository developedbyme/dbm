...
dbm.registerClass("dbm.flow.nodes.logic.IndexSwitchedNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.logic.IndexSwitchedNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.logic.IndexSwitchedNode::_init");
	...
	staticFunctions._update = function(aIndex, aIndexOffset, aArray) {
		//console.log("dbm.flow.nodes.logic.IndexSwitchedNode::_update");
	...
	objectFunctions.reset = function() {
		//console.log("dbm.flow.nodes.logic.IndexSwitchedNode::reset");
