...
dbm.registerClass("dbm.flow.nodes.parse.ParseIntNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.parse.ParseIntNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.parse.ParseIntNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.parse.ParseIntNode::_update");
