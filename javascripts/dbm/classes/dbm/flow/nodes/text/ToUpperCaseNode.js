...
dbm.registerClass("dbm.flow.nodes.text.ToUpperCaseNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.text.ToUpperCaseNode");
	
	var ToUpperCaseNode = dbm.importClass("dbm.flow.nodes.text.ToUpperCaseNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.text.ToUpperCaseNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.text.ToUpperCaseNode::_update");
