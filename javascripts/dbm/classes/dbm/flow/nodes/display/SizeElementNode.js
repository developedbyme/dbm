...
dbm.registerClass("dbm.flow.nodes.display.SizeElementNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.display.SizeElementNode");
	
	var SizeElementNode = dbm.importClass("dbm.flow.nodes.display.SizeElementNode");
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.display.SizeElementNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.display.SizeElementNode::_update");
