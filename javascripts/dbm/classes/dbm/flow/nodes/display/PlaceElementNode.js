...
dbm.registerClass("dbm.flow.nodes.display.PlaceElementNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.display.PlaceElementNode");
	...
	objectFunctions._updateElementSet = function(aFlowUpdateNumber) {
		console.log("dbm.flow.nodes.display.PlaceElementNode::_updateElementSet");
		console.log(this);
