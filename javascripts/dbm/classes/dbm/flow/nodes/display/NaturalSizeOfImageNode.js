...
dbm.registerClass("dbm.flow.nodes.display.NaturalSizeOfImageNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.display.NaturalSizeOfImageNode");
	//"use strict";
	
	var NaturalSizeOfImageNode = dbm.importClass("dbm.flow.nodes.display.NaturalSizeOfImageNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.display.NaturalSizeOfImageNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.display.NaturalSizeOfImageNode::_update");
