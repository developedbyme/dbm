...
dbm.registerClass("dbm.flow.nodes.display.VisibilityIndexSwitchedNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.display.VisibilityIndexSwitchedNode");
	
	var VisibilityIndexSwitchedNode = dbm.importClass("dbm.flow.nodes.display.VisibilityIndexSwitchedNode");
	
	var ArrayFunctions = dbm.importClass("dbm.utils.native.array.ArrayFunctions");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.display.VisibilityIndexSwitchedNode::_init");
	...
	objectFunctions.addItem = function(aItem) {
		//console.log("dbm.flow.nodes.display.VisibilityIndexSwitchedNode::addItem");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.display.VisibilityIndexSwitchedNode::_update");
	...
	objectFunctions.reset = function() {
		//console.log("dbm.flow.nodes.display.VisibilityIndexSwitchedNode::reset");
