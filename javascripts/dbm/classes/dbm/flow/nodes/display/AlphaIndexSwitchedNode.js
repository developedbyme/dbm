...
dbm.registerClass("dbm.flow.nodes.display.AlphaIndexSwitchedNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.display.AlphaIndexSwitchedNode");
	
	var AlphaIndexSwitchedNode = dbm.importClass("dbm.flow.nodes.display.AlphaIndexSwitchedNode");
	
	var ArrayFunctions = dbm.importClass("dbm.utils.native.array.ArrayFunctions");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.display.AlphaIndexSwitchedNode::_init");
	...
	objectFunctions.addItem = function(aItem) {
		//console.log("dbm.flow.nodes.display.AlphaIndexSwitchedNode::addItem");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.display.AlphaIndexSwitchedNode::_update");
	...
	objectFunctions.reset = function() {
		//console.log("dbm.flow.nodes.display.AlphaIndexSwitchedNode::reset");
