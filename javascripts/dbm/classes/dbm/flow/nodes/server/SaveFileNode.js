...
dbm.registerClass("dbm.flow.nodes.server.SaveFileNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.server.SaveFileNode");
	...
	objectFunctions._init = function() {
		console.log("dbm.flow.nodes.server.SaveFileNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.server.SaveFileNode::_update");
