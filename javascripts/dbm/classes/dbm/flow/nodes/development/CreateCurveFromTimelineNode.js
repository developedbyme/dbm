...
dbm.registerClass("dbm.flow.nodes.development.CreateCurveFromTimelineNode", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.development.CreateCurveFromTimelineNode");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.development.CreateCurveFromTimelineNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.development.CreateCurveFromTimelineNode::_update");
	...
	staticFunctions.create = function(aTimeline, aStartTime, aEndTime, aDefaultNumberOfSteps, aXOffset) {
		//console.log("dbm.flow.nodes.development.CreateCurveFromTimelineNode::create");
