...
dbm.registerClass("dbm.flow.nodes.time.TimeBreakdownNode", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.nodes.time.TimeBreakdownNode");
	
	var TimeBreakdownNode = dbm.importClass("dbm.flow.nodes.time.TimeBreakdownNode");
	
	objectFunctions._init = function() {
		//console.log("dbm.flow.nodes.time.TimeBreakdownNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("dbm.flow.nodes.time.TimeBreakdownNode::_update");
