...
dbm.registerClass("dbm.flow.analyze.FlowAnalyzeFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.analyze.FlowAnalyzeFunctions");
	//"use strict";
	...
	staticFunctions.getAllInputFlowForProperty = function(aProperty) {
		//console.log("dbm.flow.analyze.FlowAnalyzeFunctions::getAllInputFlowForProperty");
	...
	staticFunctions.getAllOutputFlowForProperty = function(aProperty) {
		//console.log("dbm.flow.analyze.FlowAnalyzeFunctions::getAllOutputFlowForProperty");
		var currentArray = new Array();
	...
	staticFunctions.findConnectionBetweenProperties = function(aStartProperty, aEndProperty, aReturnArray) {
		//console.log("dbm.flow.analyze.FlowAnalyzeFunctions::findConnectionBetweenProperties");
