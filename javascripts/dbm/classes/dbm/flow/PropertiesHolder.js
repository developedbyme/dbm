 ...
 */
dbm.registerClass("dbm.flow.PropertiesHolder", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.PropertiesHolder");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.PropertiesHolder::_init");
	...
	staticFunctions.create = function(aProperties) {
		//console.log("dbm.flow.PropertiesHolder::create");
