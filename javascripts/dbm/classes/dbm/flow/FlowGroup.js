...
dbm.registerClass("dbm.flow.FlowGroup", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.flow.FlowGroup");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.flow.FlowGroup::_init");
