...
dbm.registerClass("dbm.core.objectparts.PropertyDependentFunction", "dbm.core.objectparts.ExtendedFunctionBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.objectparts.PropertyDependentFunction");
	//"use strict";
	
	var PropertyDependentFunction = dbm.importClass("dbm.core.objectparts.PropertyDependentFunction");
	
	objectFunctions._init = function() {
		//console.log("dbm.core.objectparts.PropertyDependentFunction::_init");
	...
	objectFunctions.setFunction = function(aFunction) {
		//console.log("dbm.core.objectparts.PropertyDependentFunction::setDefaultFunction");
	...
	objectFunctions.setType = function(aType) {
		//console.log("dbm.core.objectparts.PropertyDependentFunction::setType");
	...
	objectFunctions.clear = function() {
		//console.log("dbm.core.objectparts.PropertyDependentFunction::clear");
	...
	objectFunctions.callFunction = function(aArguments) {
		//console.log("dbm.core.objectparts.PropertyDependentFunction::callFunction");
