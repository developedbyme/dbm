...
dbm.registerClass("dbm.core.objectparts.IterativeUpdateFunction", "dbm.core.objectparts.UpdateFunction", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.objectparts.IterativeUpdateFunction");
	//"use strict";
	
	var IterativeUpdateFunction = dbm.importClass("dbm.core.objectparts.IterativeUpdateFunction");
	
	objectFunctions._init = function() {
		//console.log("dbm.core.objectparts.IterativeUpdateFunction::_init");
