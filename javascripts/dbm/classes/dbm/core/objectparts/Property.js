...
dbm.registerClass("dbm.core.objectparts.Property", "dbm.core.objectparts.FlowStatusBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.objectparts.Property");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.objectparts.Property::_init");
	...
	objectFunctions.externalChangeToValue = function(aValue) {
		//console.log("dbm.core.objectparts.Property::externalChangeToValue");
	...
	objectFunctions.setValueWithFlow = function(aValue, aFlowUpdateNumber) {
		//console.log("dbm.core.objectparts.Property::setValueWithFlow");
	...
	objectFunctions.updateFlow = function() {
		//console.log("dbm.core.objectparts.Property::updateFlow");
		//console.log(this.name);
	...
	objectFunctions._linkRegistration_setInputConnection = function(aInputConnection) {
		//console.log("dbm.core.objectparts.Property::_linkRegistration_setInputConnection");
		//console.log(this.name);
		if(this._inputConnection !== null) {
	...
	objectFunctions.fillWithAllOutputConnections = function(aReturnArray) {
		//console.log("dbm.core.objectparts.Property::fillWithAllOutputConnections");
	...
	objectFunctions.setAsDirty = function() {
		//console.log("dbm.core.objectparts.Property::setAsDirty");
		//console.log(this.name);
		this.setStatus(FlowStatusTypes.NEEDS_UPDATE);
		this.flowUpdateNumber = GlobalVariables.FLOW_UPDATE_NUMBER;
		this.setDependentConnectionsAsDirty();
	...
	objectFunctions.setDependentConnectionsAsDirty = function() {
		//console.log("dbm.core.objectparts.Property::setDependentConnectionsAsDirty");
	...
	objectFunctions.setCachedDependentNodeChains = function(aNodeChains) {
		//console.log("dbm.core.objectparts.Property::setCachedDependentNodeChains");
	...
	staticFunctions.create = function(aValue) {
		//console.log("dbm.core.objectparts.Property::create");
