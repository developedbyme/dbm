...
dbm.registerClass("dbm.core.globalobjects.datamanager.setup.DefaultBasicParsersSetup", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.datamanager.setup.DefaultBasicParsersSetup");
