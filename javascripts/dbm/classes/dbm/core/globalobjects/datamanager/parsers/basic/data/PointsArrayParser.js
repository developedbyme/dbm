...
dbm.registerClass("dbm.core.globalobjects.datamanager.parsers.basic.data.PointsArrayParser", "dbm.core.globalobjects.datamanager.parsers.ParserBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.datamanager.parsers.basic.data.PointsArrayParser");
	
	//Self reference
	var PointsArrayParser = dbm.importClass("dbm.core.globalobjects.datamanager.parsers.basic.data.PointsArrayParser");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.datamanager.parsers.basic.data.PointsArrayParser::_init");
