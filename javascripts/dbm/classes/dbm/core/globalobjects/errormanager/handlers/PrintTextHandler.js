...
dbm.registerClass("dbm.core.globalobjects.errormanager.handlers.PrintTextHandler", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.errormanager.handlers.PrintTextHandler");
	//"use strict";
	...
	objectFunctions._init = function _init() {
		//console.log("dbm.core.globalobjects.errormanager.handlers.PrintTextHandler::_init");
