...
dbm.registerClass("dbm.core.globalobjects.errormanager.handlers.FlowHandler", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.errormanager.handlers.FlowHandler");
	//"use strict";
	...
	objectFunctions._init = function _init() {
		//console.log("dbm.core.globalobjects.errormanager.handlers.FlowHandler::_init");
	...
	objectFunctions.reportError = function reportError(aId, aTimeStamp, aObject, aFunctionName, aError) {
		//console.log("dbm.core.globalobjects.errormanager.handlers.FlowHandler::reportError");
