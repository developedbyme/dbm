 ...
 */
dbm.registerClass("dbm.core.globalobjects.assetrepository.assetcreators.TransformedPathAssetCreator", "dbm.core.globalobjects.assetrepository.assetcreators.PathAssetCreator", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.assetrepository.assetcreators.TransformedPathAssetCreator");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.assetrepository.assetcreators.TransformedPathAssetCreator::_init");
