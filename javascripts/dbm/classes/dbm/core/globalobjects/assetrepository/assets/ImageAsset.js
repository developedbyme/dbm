...
dbm.registerClass("dbm.core.globalobjects.assetrepository.assets.ImageAsset", "dbm.core.globalobjects.assetrepository.assets.Asset", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.assetrepository.assets.ImageAsset");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.assetrepository.assets.ImageAsset::_init");
	...
	objectFunctions.setUrl = function(aUrl) {
		//console.log("dbm.core.globalobjects.assetrepository.assets.ImageAsset::setUrl");
		//console.log(aUrl);
	...
	objectFunctions.load = function() {
		//console.log("dbm.core.globalobjects.assetrepository.assets.ImageAsset::load");
