...
dbm.registerClass("dbm.core.globalobjects.assetrepository.assets.AudioAsset", "dbm.core.globalobjects.assetrepository.assets.Asset", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.assetrepository.assets.AudioAsset");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.assetrepository.assets.AudioAsset::_init");
	...
	objectFunctions.setUrl = function(aUrl) {
		//console.log("dbm.core.globalobjects.assetrepository.assets.AudioAsset::setUrl");
		//console.log(aUrl);
	...
	objectFunctions.load = function() {
		//console.log("dbm.core.globalobjects.assetrepository.assets.AudioAsset::load");
	...
	objectFunctions._loadProgressCallback = function(aEvent) {
		//console.log("dbm.core.globalobjects.assetrepository.assets.AudioAsset::_loadProgress");
		//console.log(aEvent);
