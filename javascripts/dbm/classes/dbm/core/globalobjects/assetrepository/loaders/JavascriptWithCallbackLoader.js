...
dbm.registerClass("dbm.core.globalobjects.assetrepository.loaders.JavascriptWithCallbackLoader", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.assetrepository.loaders.JavascriptWithCallbackLoader");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.JavascriptWithCallbackLoader::_init");
	...
	objectFunctions.load = function() {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.JavascriptWithCallbackLoader::load");
		//console.log(this);
