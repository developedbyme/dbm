 ...
 */
dbm.registerClass("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence::_init");
	...
	objectFunctions.load = function() {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence::load");
	...
	objectFunctions.addAsset = function(aAsset) {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence::addAsset");
	...
	objectFunctions._loadLoader = function(aLoader) {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence::_loadLoader");
	...
	objectFunctions._hasWaitingLoaders = function() {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence::_hasWaitingLoaders");
	...
	objectFunctions._continueLoading = function() {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence::_continueLoading");
	...
	objectFunctions._loaderLoaded = function(aLoader) {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence::_loaderLoaded");
	...
	objectFunctions._updateProgressFlow = function(aFlowUpdateNumber) {
		//console.log("dbm.core.globalobjects.assetrepository.loaders.LoadingSequence::_updateProgressFlow");
