...
dbm.registerClass("dbm.core.globalobjects.audiomanager.audio.PlayingAudio", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.audiomanager.audio.PlayingAudio");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.audiomanager.audio.PlayingAudio::_init");
	...
	objectFunctions._performPlay = function() {
		//console.log("dbm.core.globalobjects.audiomanager.audio.PlayingAudio::_performPlay");
	...
	objectFunctions.pause = function() {
		//console.log("dbm.core.globalobjects.audiomanager.audio.PlayingAudio::pause");
	...
	objectFunctions.stop = function() {
		//console.log("dbm.core.globalobjects.audiomanager.audio.PlayingAudio::stop");
	...
	objectFunctions.updateTime = function(aTime, aFrame) {
		//console.log("dbm.core.globalobjects.audiomanager.audio.PlayingAudio::updateTime");
