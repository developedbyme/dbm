...
dbm.registerClass("dbm.core.globalobjects.curveevaluator.evaluators.BSplineEvaluator", "dbm.core.globalobjects.curveevaluator.evaluators.EvaluatorBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.curveevaluator.evaluators.BSplineEvaluator");
	
	var Point = dbm.importClass("dbm.core.data.points.Point");
	
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.curveevaluator.evaluators.BSplineEvaluator::_init")
	...
	staticFunctions.getPartOfCurve = function(aCurve, aStartParameter, aEndParameter, aExactness, aReturnCurve) {
		//console.log("dbm.core.globalobjects.curveevaluator.evaluators.BSplineEvaluator::getPartOfCurve");
		var theCurve = aCurve;
