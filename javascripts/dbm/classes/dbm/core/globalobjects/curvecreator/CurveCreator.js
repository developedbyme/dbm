 ...
 */
dbm.registerClass("dbm.core.globalobjects.curvecreator.CurveCreator", "dbm.core.globalobjects.GlobalObjectBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.curvecreator.CurveCreator");
	//"use strict";
	...
	objectFunctions.createRectangle = function(aX, aY, aWidth, aHeight) {
		//console.log("dbm.core.globalobjects.curvecreator.CurveCreator::createRectangle");
	...
	objectFunctions.createCircle = function(aX, aY, aRadius, aNumberOfSegments, aStartAngle) {
		//console.log("dbm.core.globalobjects.curvecreator.CurveCreator::createCircle");
	...
	objectFunctions.setEndOfLinearSegment = function(aStartX, aStartY, aEndX, aEndY, aReturnCurve, aPositionOnCurve) {
		//console.log("dbm.core.globalobjects.curvecreator.CurveCreator::setEndOfLinearSegment");
	...
	objectFunctions.ensureNextSegments = function(aReturnCurve, aPositionOnCurve, aNumberOfSegments) {
		//console.log("dbm.core.globalobjects.curvecreator.CurveCreator::ensureNextSegments");
