...
dbm.registerClass("dbm.core.globalobjects.windowmanager.WindowManager", "dbm.core.globalobjects.GlobalObjectBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.windowmanager.WindowManager");
	...
	objectFunctions.addToSharedRandomValues = function(aValuesArray) {
		console.log("dbm.core.globalobjects.windowmanager.WindowManager::addToSharedRandomValues");
	...
	objectFunctions.setMasterWindow = function(aWindow) {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::setMasterWindow");
	...
	objectFunctions.getWindow = function(aName) {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::getWindow");
	...
	objectFunctions.getScreenSizeNode = function() {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::getScreenSizeNode");
	...
	objectFunctions.setDefaultMargins = function(aWidth, aHeight, aLeft, aTop, aRight, aBottom) {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::setDefaultMargins");
	...
	objectFunctions.getDefaultMargins = function() {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::getDefaultMargins");
	...
	objectFunctions.hasDefaultMargins = function() {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::hasDefaultMargins");
	...
	objectFunctions.createWindow = function(aName, aUrl, aWidth, aHeight) {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::createWindow");
	...
	objectFunctions.createWindowFromExisiting = function(aName, aWindow) {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::createWindowFromExisiting");
	...
	objectFunctions._setWindowAsHighestDepth = function(aWindow) {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::_setWindowAsHighestDepth");
	...
	objectFunctions._windowClosed = function(aWindow) {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::_windowClosed");
		var position = ArrayFunctions.indexOfInArray(this._windowsOrder, aWindow);
		if(position !== -1) {
			this._windowsOrder.splice(position, 1);
		}
	...
	objectFunctions._updateFlowDepth = function(aFlowUpdateNumber) {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::_updateFlowDepth");
	...
	objectFunctions.updateDepths = function() {
		//console.log("dbm.core.globalobjects.windowmanager.WindowManager::updateDepths");
