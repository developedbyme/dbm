 ...
 * @version	0.0.01
 */
dbm.registerClass("dbm.core.globalobjects.windowmanager.objects.Window", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.windowmanager.objects.Window");
	
	//Self reference
	var Window = dbm.importClass("dbm.core.globalobjects.windowmanager.objects.Window");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_init");
	...
	objectFunctions.setUrl = function(aUrl) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::setUrl");
	...
	objectFunctions.setPosition = function(aX, aY) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::setPosition");
	...
	objectFunctions.setSize = function(aWidth, aHeight) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::setSize");
	...
	objectFunctions._updateFlowSize = function(aFlowUpdateNumber) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_updateFlowSize");
	...
	objectFunctions._updateFlowPosition = function(aFlowUpdateNumber) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_updateFlowPosition");
		if(this._isOpen) {
	...
	objectFunctions._updateIconFlow = function(aFlowUpdateNumber) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_updateIconFlow");
		if(this._isOpen) {
	...
	objectFunctions._updateSize = function(aWidth, aHeight) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_updateSize");
	...
	objectFunctions._updateSizeBy = function(aWidth, aHeight) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_updateSizeBy");
	...
	objectFunctions._updatePosition = function(aX, aY) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_updatePosition");
		this._updatePositionFunction.callFunction(arguments);
	};
	
	objectFunctions._browser_firefox_updatePosition = function(aX, aY) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_browser_firefox_updatePosition");
		this._window.moveTo(aX, aY);
	};
	
	objectFunctions._browser_msie_updatePosition = function(aX, aY) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_browser_msie_updatePosition");
	...
	objectFunctions._browser_default_updatePosition = function(aX, aY) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_browser_default_updatePosition");
		try {
	...
	objectFunctions._sizeUpdated = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_sizeUpdate");
	...
	objectFunctions._positionUpdated = function(aX, aY) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_positionUpdated");
		//console.log(aX, aY);
	...
	objectFunctions._mousePositionUpdate = function(aEvent) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_mousePositionUpdate");
	...
	objectFunctions._documentReadyCallback = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_documentReadyCallback");
	...
	objectFunctions._documentLoadedCallback = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_documentLoadedCallback");
		//console.log(this.name, this);
		this._documentReady.setValue(true);
	};
	
	objectFunctions._documentUnloadedCallback = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_documentUnloadedCallback");
		//console.log(this.name, this);
		this._documentLoaded.setValue(true);
	};
	
	objectFunctions._checkForLastPosition = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_checkForLastPosition");
	...
	objectFunctions._setupIconLink = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_setupIconLink");
	...
	objectFunctions.setFeatures = function(aStatus, aToolbar, aLocation, aMenubar, aDirectories, aResizable, aScrollbars) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::setFeatures");
	...
	objectFunctions.open = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::open");
	...
	objectFunctions._browser_default_windowReadyDirectly = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_browser_default_windowReadyDirectly");
		//MENOTE: do nothing
	};
	
	objectFunctions._browser_msie_windowReadyDirectly = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::_browser_msie_windowReadyDirectly");
	...
	objectFunctions.close = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::close");
	...
	objectFunctions.updateTime = function(aTime, aFrame) {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::updateTime");
	...
	objectFunctions.performDestroy = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::performDestroy");
		if(this._isOpen) {
			this.close();
		}
	...
	objectFunctions.setAllReferencesToNull = function() {
		//console.log("dbm.core.globalobjects.windowmanager.objects.Window::setAllReferencesToNull");
