...
dbm.registerClass("dbm.core.globalobjects.debugmanager.DebugManager", "dbm.core.globalobjects.GlobalObjectBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.debugmanager.DebugManager");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.debugmanager.DebugManager::_init");
	...
	objectFunctions.objectCreated = function(aType) {
		//console.log("dbm.core.globalobjects.debugmanager.DebugManager::objectCreated");
	...
	objectFunctions.objectDestroyed = function(aType) {
		//console.log("dbm.core.globalobjects.debugmanager.DebugManager::objectDestroyed");
		if(!this._objectCount.hasObject(aType)) {
			this._objectCount.addObject(aType, 0);
		}
		this._objectCount.replaceObject(aType, this._objectCount.getObject(aType)-1);
	...
	objectFunctions.printNumberOfCreatedObjects = function() {
		console.log("dbm.core.globalobjects.debugmanager.DebugManager::printNumberOfCreatedObjects");
	...
	objectFunctions.setCheckForDeletion = function(aCheck) {
		//console.log("dbm.core.globalobjects.debugmanager.DebugManager::setCheckForDeletion");
		
		this._isCheckingForDeletion = aCheck;
	};
	
	objectFunctions.checkThatObjectIsDestroyed = function(aObject) {
		//console.log("dbm.core.globalobjects.debugmanager.DebugManager::checkThatObjectIsDestroyed");
		//console.log(aObject)
	...
	objectFunctions.checkThatObjectHasNoReferences = function(aObject) {
		//console.log("dbm.core.globalobjects.debugmanager.DebugManager::checkThatObjectHasNoReferences");
