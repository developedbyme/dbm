...
dbm.registerClass("dbm.core.globalobjects.updatemanager.timer.TimerBaseObject", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.globalobjects.updatemanager.timer.TimerBaseObject");
	
	//Self reference
	var TimerBaseObject = dbm.importClass("dbm.core.globalobjects.updatemanager.timer.TimerBaseObject");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.globalobjects.updatemanager.timer.TimerBaseObject::_init");
	...
	objectFunctions.setUpdateObject = function(aObject) {
		//console.log("dbm.core.globalobjects.updatemanager.timer.TimerBaseObject::setUpdateObject");
	...
	objectFunctions.start = function() {
		//console.log("dbm.core.globalobjects.updatemanager.timer.TimerBaseObject::start");
		if(!this._isStarted) {
	...
	objectFunctions.stop = function() {
		//console.log("dbm.core.globalobjects.updatemanager.timer.TimerBaseObject::stop");
		if(this._isStarted) {
			this._isStarted = false;
			this._performStop();
		}
	...
	objectFunctions.update = function() {
		//console.log("dbm.core.globalobjects.updatemanager.timer.TimerBaseObject::update");
