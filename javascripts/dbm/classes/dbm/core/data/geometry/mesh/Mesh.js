 ...
 * A mesh of faces.
 */
dbm.registerClass("dbm.core.data.geometry.mesh.Mesh", "dbm.core.data.points.PointSet", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.geometry.mesh.Mesh");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.data.geometry.mesh.Mesh::_init");
	...
	staticFunctions.create = function() {
		//console.log("dbm.core.data.geometry.mesh.Mesh::create (static)");
