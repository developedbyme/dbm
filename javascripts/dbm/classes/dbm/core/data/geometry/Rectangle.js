...
dbm.registerClass("dbm.core.data.geometry.Rectangle", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.geometry.Rectangle");
	...
	staticFunctions.create = function(aX, aY, aWidth, aHeight) {
		//console.log("dbm.core.data.geometry.Rectangle::create (static)");
