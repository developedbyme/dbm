 ...
 * A CMYK color.
 */
dbm.registerClass("dbm.core.data.color.CmykColor", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.color.CmykColor");
	...
	staticFunctions.create = function(aC, aM, aY, aK) {
		//console.log("dbm.core.data.color.CmykColor::create (static)");
