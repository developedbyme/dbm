...
dbm.registerClass("dbm.core.data.points.CoordinateSystem", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.points.CoordinateSystem");
	...
	objectFunctions.setAsNormalCoordinateSystem = function() {
		//console.log("dbm.core.data.points.CoordinateSystem.setAsNormalCoordinateSystem");
	...
	objectFunctions.getFromTransformationMatrix = function(aReturnMatrix) {
		//console.log("dbm.core.data.points.CoordinateSystem.getFromTransformationMatrix");
	...
	objectFunctions.transformPointSetToCoordinateSystem = function(aInputPointSet, aOutputPointSet) {
		//console.log("dbm.core.data.points.CoordinateSystem.transformPointSetToCoordinateSystem");
	...
	objectFunctions.transformPointSetFromCoordinateSystem = function(aInputPointSet, aOutputPointSet) {
		//console.log("dbm.core.data.points.CoordinateSystem.transformPointSetFromCoordinateSystem");
