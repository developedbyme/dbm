 ...
 * A point.
 */
dbm.registerClass("dbm.core.data.points.Point", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.points.Point");
	//"use strict";
	...
	objectFunctions.setValues = function(aX, aY, aZ, aW) {
		//console.log("dbm.core.data.points.Point::setValues");
	...
	staticFunctions.create = function(aX, aY, aZ, aW) {
		//console.log("dbm.core.data.points.Point::create (static)");
		//console.log(aX, aY, aZ, aW);
	...
	staticFunctions.getLengthOfVectorValues2d = function(aX, aY) {
		//console.log("dbm.core.data.points.Point::getLengthOfVectorValues2d (static)");
		//console.log(aX, aY);
		return Math.sqrt(Math.pow(aX, 2)+Math.pow(aY, 2));
	};
	
	staticFunctions.getLengthOfVectorValues3d = function(aX, aY, aZ) {
		//console.log("dbm.core.data.points.Point::getLengthOfVectorValues3d (static)");
	...
	staticFunctions.copyPointValues3d = function(aInputPoint, aOutputPoint) {
		//console.log("dbm.core.data.points.Point::copyPointValues3d (static)");
