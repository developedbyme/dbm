 ...
 */
dbm.registerClass("dbm.core.data.points.PointSet", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.points.PointSet");
	//"use strict";
	...
	objectFunctions.setupFromArray = function(aArray, aNumberOfDimesions) {
		//console.log("dbm.core.data.points.PointSet::setupFromArray");
