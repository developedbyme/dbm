...
dbm.registerClass("dbm.core.data.matrices.TransformationMatrix3d", "dbm.core.data.matrices.Matrix", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.matrices.TransformationMatrix3d");
