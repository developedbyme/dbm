 ...
 */
dbm.registerClass("dbm.core.data.matrices.Matrix", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.matrices.Matrix");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.data.matrices.Matrix::_init");
	...
	objectFunctions.setupSize = function(aSizeH, aSizeV) {
		//console.log("dbm.core.data.matrices.Matrix::setupSize");
	...
	staticFunctions.multiplyMatrices = function(aInputMatrix1, aInputMatrix2, aOutputMatrix) {
		//console.log("dbm.core.data.matrices.Matrix.(static)multiplyMatrices");
	...
	staticFunctions.create = function(aWidth, aHeight) {
		//console.log("dbm.core.data.matrices.Matrix::create (static)");
	...
	staticFunctions.createIdentity = function(aWidth, aHeight) {
		//console.log("dbm.core.data.matrices.Matrix::createIdentity (static)");
		//console.log(aWidth, aHeight);
		var newMatrix = (new ClassReference()).init();
		newMatrix.setupSize(aWidth, aHeight);
	...
	staticFunctions.createWithValues = function(aWidth, aHeight, aValues) {
		//console.log("dbm.core.data.matrices.Matrix::createWithValues (static)");
