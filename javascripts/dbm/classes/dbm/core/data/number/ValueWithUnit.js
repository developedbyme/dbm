...
dbm.registerClass("dbm.core.data.number.ValueWithUnit", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.number.ValueWithUnit");
	...
	staticFunctions.create = function create(aValue, aUnitType) {
		//console.log("dbm.core.data.number.ValueWithUnit::create (static)");
	...
	staticFunctions.parseValue = function parseValue(aValue, aReturnValueWithUnit, aDefaultUnitType) {
		//console.log("dbm.core.data.number.ValueWithUnit::parseValue (static)");
