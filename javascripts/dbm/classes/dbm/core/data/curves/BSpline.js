...
dbm.registerClass("dbm.core.data.curves.BSpline", "dbm.core.data.curves.Curve", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.data.curves.BSpline");
	
	var BSpline = dbm.importClass("dbm.core.data.curves.BSpline");
	...
	objectFunctions.setupFromArrayWithUniformKnots = function(aValuesArray) {
		//console.log("dbm.core.data.curves.BSpline.setupFromArrayWithUniformKnots");
	...
	objectFunctions._realBezierBaseFunctionRecursive = function(aPointNr, aDegree, aParameter) {
		//console.log("dbm.core.data.curves.BSpline.Debug::realBezierBaseFunctionRecursive");
	...
	objectFunctions._realGetPointOnCurve = function(aParameter, aOutputPoint) {
		//console.log("dbm.core.data.curves.BSpline.Debug::realGetPointOnCurve");
		var x = 0;
		var y = 0;
		var z = 0;
	...
	objectFunctions.getPointOnCurve = function(aParameter, aOutputPoint) {
		//console.log("dbm.core.data.curves.BSpline.getPointOnCurve");
		//METODO
