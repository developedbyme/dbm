...
dbm.registerClass("dbm.core.extendedevent.DelayedExtendedEventController", "dbm.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.extendedevent.DelayedExtendedEventController");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.extendedevent.DelayedExtendedEventController::_init");
	...
	objectFunctions.setOwner = function(aOwner) {
		//console.log("dbm.core.extendedevent.DelayedExtendedEventController::setOwner");
		//console.log(aOwner);
	...
	objectFunctions.addFunctionCall = function(aObject, aFunction, aArguments, aDelay) {
		//console.log("dbm.core.extendedevent.DelayedExtendedEventController::addFunctionCall");
	...
	objectFunctions.addFunctionCallAt = function(aObject, aFunction, aArguments, aTime) {
		//console.log("dbm.core.extendedevent.DelayedExtendedEventController::addFunctionCallAt");
