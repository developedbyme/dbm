...
dbm.registerClass("dbm.core.extendedevent.setup.InteractionExtendedEventSetup", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.extendedevent.setup.InteractionExtendedEventSetup");
	...
	staticFunctions.addPressEvents = function(aExtendedEventController, aHtmlElement, aActivate, aUseCapture) {
		//console.log("dbm.core.extendedevent.setup.InteractionExtendedEventSetup::addPressEvents");
	...
	staticFunctions.addPressWithMoveEvents = function(aExtendedEventController, aHtmlElement, aActivate, aUseCapture) {
		//(console.log("dbm.core.extendedevent.setup.InteractionExtendedEventSetup::addPressWithMoveEvents");
	...
	staticFunctions.addTouchPressEvents = function(aExtendedEventController, aHtmlElement, aActivate, aUseCapture) {
		//console.log("dbm.core.extendedevent.setup.InteractionExtendedEventSetup::addTouchPressEvents");
		//console.log(aExtendedEventController, aHtmlElement, aActivate);
		//console.log(DomReferenceFunctions.getDocument(aHtmlElement));
	...
	staticFunctions.addTouchPressWithMoveEvents = function(aExtendedEventController, aHtmlElement, aActivate, aUseCapture) {
		//console.log("dbm.core.extendedevent.setup.InteractionExtendedEventSetup::addTouchPressWithMoveEvents");
		//console.log(aExtendedEventController, aHtmlElement, aActivate);
	...
	staticFunctions.preventDefaultForEvent = function(aExtendedEventController, aEventName) {
		//(console.log("dbm.core.extendedevent.setup.InteractionExtendedEventSetup::preventDefaultForEvent");
