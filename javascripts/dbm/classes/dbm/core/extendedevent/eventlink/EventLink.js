...
dbm.registerClass("dbm.core.extendedevent.eventlink.EventLink", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.extendedevent.eventlink.EventLink");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.extendedevent.eventlink.EventLink::_init");
	...
	objectFunctions.activate = function() {
		//console.log("dbm.core.extendedevent.eventlink.EventLink::activate");
	...
	objectFunctions.deactivate = function() {
		//console.log("dbm.core.extendedevent.eventlink.EventLink::deactivate");
		if(!this._isActive) return this;
	...
	objectFunctions.reactivate = function() {
		//console.log("dbm.core.extendedevent.eventlink.EventLink::reactivate");
	...
	objectFunctions.performDestroy = function() {
		//console.log("dbm.core.extendedevent.eventlink.EventLink::performDestroy");
