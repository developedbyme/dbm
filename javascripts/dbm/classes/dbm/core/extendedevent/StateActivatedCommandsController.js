...
dbm.registerClass("dbm.core.extendedevent.StateActivatedCommandsController", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.extendedevent.StateActivatedCommandsController");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.extendedevent.StateActivatedCommandsController::_init");
	...
	objectFunctions._activateState = function(aStateName) {
		//console.log("dbm.core.extendedevent.StateActivatedCommandsController::_activateState");
	...
	objectFunctions._deactivateState = function(aStateName) {
		//console.log("dbm.core.extendedevent.StateActivatedCommandsController::_deactivateState");
		//console.log(aStateName);
	...
	objectFunctions.setEventPerformer = function(aEventPerformer) {
		//console.log("dbm.core.extendedevent.StateActivatedCommandsController::setEventPerformer");
	...
	objectFunctions.addCommandToEvent = function(aStateName, aEventName, aCommand) {
		//console.log("dbm.core.extendedevent.StateActivatedCommandsController::addCommandToEvent");
