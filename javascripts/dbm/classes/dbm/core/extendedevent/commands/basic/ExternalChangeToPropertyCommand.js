...
dbm.registerClass("dbm.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand", "dbm.core.extendedevent.commands.CommandBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand");
	
	//Self reference
	var ExternalChangeToPropertyCommand = dbm.importClass("dbm.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand::_init");
	...
	objectFunctions.perform = function(aEventDataObject) {
		//console.log("dbm.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand::perform");
		...
		theProperty.externalChangeToValue(theValue);
	...
	staticFunctions.createCommand = function(aProperty, aValue) {
		//console.log("dbm.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand::createCommand (static)");
		//console.log(aProperty, aValue);
		var newCommand = (new ExternalChangeToPropertyCommand()).init();
	...
	staticFunctions.createSetPropertyOnObjectCommand = function(aObject, aPropertyName, aValue) {
		//console.log("dbm.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand::createSetPropertyOnObjectCommand (static)");
