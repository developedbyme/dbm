...
dbm.registerClass("dbm.core.extendedevent.commands.htmldom.RebaseDocumentLinksCommand", "dbm.core.extendedevent.commands.htmldom.BaseElementCommand", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.extendedevent.commands.htmldom.RebaseDocumentLinksCommand");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.extendedevent.commands.htmldom.RebaseDocumentLinksCommand::_init");
	...
	objectFunctions.perform = function(aEventDataObject) {
		//console.log("dbm.core.extendedevent.commands.htmldom.RebaseDocumentLinksCommand::perform");
	...
	staticFunctions.createCommand = function(aElement, aUrlResolver) {
		//console.log("dbm.core.extendedevent.commands.htmldom.RebaseDocumentLinksCommand::createCommand");
	...
	staticFunctions.createOnTemplateOutputCommand = function(aUrlResolver) {
		//console.log("dbm.core.extendedevent.commands.htmldom.RebaseDocumentLinksCommand::createOnTemplateOutputCommand");
