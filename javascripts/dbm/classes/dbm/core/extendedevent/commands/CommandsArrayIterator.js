...
dbm.registerClass("dbm.core.extendedevent.commands.CommandsArrayIterator", "dbm.utils.data.iterator.ActiveRetainArrayIterator", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.core.extendedevent.commands.CommandsArrayIterator");
	...
	objectFunctions._init = function() {
		//console.log("dbm.core.extendedevent.commands.CommandsArrayIterator::_init");
	...
	objectFunctions.removeItemById = function(aId) {
		//console.log("dbm.core.extendedevent.commands.CommandsArrayIterator::removeItemById");
