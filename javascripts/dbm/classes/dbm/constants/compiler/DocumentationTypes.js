 ...
 */
dbm.registerClass("dbm.constants.compiler.DocumentationTypes", null, function(objectFunctions, staticFunctions) {
	//console.log("dbm.constants.compiler.DocumentationTypes");
