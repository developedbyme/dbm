...
dbm.registerClass("dbm.constants.fileformats.midi.MidiEventTypes", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.constants.fileformats.midi.MidiEventTypes");
	//"use strict";
