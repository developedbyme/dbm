...
dbm.registerClass("dbm.constants.webgl.WebglBeginModeTypes", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.constants.webgl.WebglBeginModeTypes");
