...
dbm.registerClass("dbm.constants.webgl.WebglFilterTypes", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.constants.webgl.WebglFilterTypes");
