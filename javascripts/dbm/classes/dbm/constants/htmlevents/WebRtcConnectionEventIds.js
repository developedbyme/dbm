...
dbm.registerClass("dbm.constants.htmlevents.WebRtcConnectionEventIds", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.constants.htmlevents.WebRtcConnectionEventIds");
