...
dbm.registerClass("dbm.constants.htmlevents.IndexedDatabaseEventIds", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.constants.htmlevents.IndexedDatabaseEventIds");
