...
dbm.registerClass("dbm.constants.websocket.SharedPropertyDataTypes", null, function(objectFunctions, staticFunctions) {
	//console.log("dbm.constants.websocket.SharedPropertyDataTypes");
