 ...
 */
dbm.registerClass("dbm.compiler.breakdown.BreakdownFunctions", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.breakdown.BreakdownFunctions");
	...
	staticFunctions.getBreakdownWithoutComments = function(aBreakdownPart) {
		//console.log("dbm.compiler.breakdown.BreakdownFunctions::getBreakdownWithoutComments");
	...
	staticFunctions.checkForReturnStatement = function(aBreakdownPart) {
		//console.log("dbm.compiler.breakdown.BreakdownFunctions::checkForReturnStatement");
		//console.log(aBreakdownPart);
