...
/**
 * Script breakdoen of a variable declaration. 
 */
dbm.registerClass("dbm.compiler.breakdown.ScriptBreakdownVarPart", "dbm.compiler.breakdown.ScriptBreakdownPart", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.breakdown.ScriptBreakdownVarPart");
	...
	objectFunctions._init = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownVarPart::_init");
		
		this.superCall();
		
		this._type = BreakdownTypes.DECLARE_VARIABLE;
	...
	objectFunctions._breakdown = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownVarPart::_breakdown");
	...
	objectFunctions._childsBrokenDown = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownVarPart::_childsBrokenDown");
	...
	objectFunctions.compile = function(aCompileData) {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownVarPart::compile");
