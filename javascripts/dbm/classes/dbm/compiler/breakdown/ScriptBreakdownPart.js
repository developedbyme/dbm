 ...
 */
dbm.registerClass("dbm.compiler.breakdown.ScriptBreakdownPart", "dbm.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.breakdown.ScriptBreakdownPart");
	...
	objectFunctions._init = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownPart::_init");
	...
	objectFunctions._internalFunctionality_removeChildBreakdown = function(aChildBreakdown) {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownPart::_internalFunctionality_removeChildBreakdown");
	...
	objectFunctions._breakdown = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownPart::_breakdown");
	...
	objectFunctions._childsBrokenDown = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownPart::_childsBrokenDown");
		
		//MENOTE: should be overridden
	};
	
	objectFunctions._getCommaArray = function(aText) {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownCodePart::_getCommaArray");
	...
	objectFunctions._getColonPosition = function(aText) {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownCodePart::_getColonPosition");
