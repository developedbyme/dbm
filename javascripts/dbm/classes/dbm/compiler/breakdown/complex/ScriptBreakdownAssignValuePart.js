 ...
 */
dbm.registerClass("dbm.compiler.breakdown.complex.ScriptBreakdownAssignValuePart", "dbm.compiler.breakdown.ScriptBreakdownPart", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.breakdown.complex.ScriptBreakdownAssignValuePart");
	...
	objectFunctions._init = function() {
		//console.log("dbm.compiler.breakdown.complex.ScriptBreakdownAssignValuePart::_init");
	...
	objectFunctions._breakdown = function() {
		//console.log("dbm.compiler.breakdown.complex.ScriptBreakdownAssignValuePart::_breakdown");
		
		//METODO: some kind of error message here?
	};
	
	objectFunctions.compile = function(aCompileData) {
		//console.log("dbm.compiler.breakdown.complex.ScriptBreakdownAssignValuePart::compile");
