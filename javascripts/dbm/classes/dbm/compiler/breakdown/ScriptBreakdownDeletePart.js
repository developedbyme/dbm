 ...
 */
dbm.registerClass("dbm.compiler.breakdown.ScriptBreakdownDeletePart", "dbm.compiler.breakdown.ScriptBreakdownPart", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.breakdown.ScriptBreakdownDeletePart");
	...
	objectFunctions._init = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownDeletePart::_init");
	...
	objectFunctions._breakdown = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownDeletePart::_breakdown");
		if(this._script !== "") {
	...
	objectFunctions.compile = function(aCompileData) {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownDeletePart::compile");
