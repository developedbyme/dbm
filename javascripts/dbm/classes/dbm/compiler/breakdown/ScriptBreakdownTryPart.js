...
/**
 * Script breakdown of a try scope.
 */
dbm.registerClass("dbm.compiler.breakdown.ScriptBreakdownTryPart", "dbm.compiler.breakdown.ScriptBreakdownPart", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.breakdown.ScriptBreakdownTryPart");
	...
	objectFunctions._init = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownTryPart::_init");
		
		this.superCall();
		
		this._type = BreakdownTypes.TRY;
		this._code = null;
	...
	objectFunctions._breakdown = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownTryPart::_breakdown");
	...
	objectFunctions.compile = function(aCompileData) {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownTryPart::compile");
