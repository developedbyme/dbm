...
/**
 * Script breakdown of a finally scope.
 */
dbm.registerClass("dbm.compiler.breakdown.ScriptBreakdownFinallyPart", "dbm.compiler.breakdown.ScriptBreakdownPart", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.breakdown.ScriptBreakdownFinallyPart");
	...
	objectFunctions._init = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownFinallyPart::_init");
		
		this.superCall();
		
		this._type = BreakdownTypes.FINALLY;
		this._code = null;
	...
	objectFunctions._breakdown = function() {
		//console.log("dbm.compiler.breakdown.ScriptBreakdownFinallyPart::_breakdown");
