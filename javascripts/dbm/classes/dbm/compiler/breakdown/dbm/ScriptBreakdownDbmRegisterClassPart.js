 ...
 */
dbm.registerClass("dbm.compiler.breakdown.dbm.ScriptBreakdownDbmRegisterClassPart", "dbm.compiler.breakdown.ScriptBreakdownPart", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.breakdown.dbm.ScriptBreakdownDbmRegisterClassPart");
	...
	objectFunctions._init = function() {
		//console.log("dbm.compiler.breakdown.dbm.ScriptBreakdownDbmRegisterClassPart::_init");
	...
	objectFunctions.getLocalFunctionsVariableName = function() {
		//console.log("dbm.compiler.breakdown.dbm.ScriptBreakdownDbmRegisterClassPart::getLocalFunctionsVariableName");
	...
	objectFunctions.getStaticFunctionsVariableName = function() {
		//console.log("dbm.compiler.breakdown.dbm.ScriptBreakdownDbmRegisterClassPart::getStaticFunctionsVariableName");
		//console.log(this._declarationFunction);
	...
	objectFunctions._breakdown = function() {
		//console.log("dbm.compiler.breakdown.dbm.ScriptBreakdownDbmRegisterClassPart::_breakdown");
		
		//METODO: some kind of error message here?
	};
	
	objectFunctions.compile = function(aCompileData) {
		//console.log("dbm.compiler.breakdown.dbm.ScriptBreakdownDbmRegisterClassPart::compile");
