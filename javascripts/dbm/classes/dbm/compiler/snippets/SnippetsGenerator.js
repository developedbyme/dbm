 ...
 */
dbm.registerClass("dbm.compiler.snippets.SnippetsGenerator", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.snippets.SnippetsGenerator");
	...
	staticFunctions.createImport = function(aClassPath) {
		//console.log("dbm.compiler.snippets.SnippetsGenerator::createImport");
	...
	staticFunctions.getClassNameFromPath = function(aClassPath) {
		//console.log("dbm.compiler.snippets.SnippetsGenerator::getClassNameFromPath");
		//console.log(aClassPath);
