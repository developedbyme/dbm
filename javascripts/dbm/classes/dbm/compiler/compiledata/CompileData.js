 ...
 */
dbm.registerClass("dbm.compiler.compiledata.CompileData", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.compiledata.CompileData");
	...
	objectFunctions._init = function() {
		//console.log("dbm.compiler.compiledata.CompileData::_init");
	...
	objectFunctions.removeLastScope = function() {
		//console.log("dbm.compiler.compiledata.CompileData::removeLastScope");
