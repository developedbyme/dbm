 ...
 */
dbm.registerClass("dbm.compiler.DbmCompiler", "dbm.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.compiler.DbmCompiler");
	...
	objectFunctions._init = function() {
		//console.log("dbm.compiler.DbmCompiler::_init");
	...
	objectFunctions.addFiles = function(/* ... aFiles*/) {
		//console.log("dbm.compiler.DbmCompiler::addFiles");
	...
	objectFunctions.load = function() {
		//console.log("dbm.compiler.DbmCompiler::load");
		
		this._loader.load();
	};
	
	objectFunctions.addFile = function(aPath, aPosition) {
		//console.log("dbm.compiler.DbmCompiler::addFile");
	...
	objectFunctions._fileLoaded = function(aPath, aAsset) {
		//console.log("dbm.compiler.DbmCompiler::_fileLoaded");
		//console.log(aPath);
	...
	objectFunctions.combineFiles = function() {
		console.log("dbm.compiler.DbmCompiler::combineFiles");
	...
	objectFunctions.compileFiles = function() {
		console.log("dbm.compiler.DbmCompiler::compileFiles");
	...
	objectFunctions.documentFiles = function() {
		console.log("dbm.compiler.DbmCompiler::documentFiles");
	...
	objectFunctions.documentFile = function(aPath, aTreeStructureItem) {
		//console.log("dbm.compiler.DbmCompiler::documentFile");
