...
dbm.registerClass("dbm.workspace.gui.panels.BasePanel", "dbm.gui.DisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("dbm.workspace.gui.panels.BasePanel");
	//"use strict";
	
	var BasePanel = dbm.importClass("dbm.workspace.gui.panels.BasePanel");
	...
	objectFunctions._init = function() {
		//console.log("dbm.workspace.gui.panels.BasePanel::_init");
