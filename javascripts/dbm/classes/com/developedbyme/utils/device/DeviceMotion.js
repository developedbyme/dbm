 ...
 */
dbm.registerClass("com.developedbyme.utils.device.DeviceMotion", "com.developedbyme.core.ExtendedEventBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.utils.device.DeviceMotion");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.utils.device.DeviceMotion::_init");
	...
	objectFunctions._motionUpdated = function(aEvent) {
		//console.log("com.developedbyme.utils.device.DeviceMotion::_motionUpdated");
		//console.log(aEvent);
	...
	objectFunctions.startUpdating = function() {
		console.log("com.developedbyme.utils.device.DeviceMotion::startUpdating");
