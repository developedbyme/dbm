 ...
 */
dbm.registerClass("com.developedbyme.utils.canvas.pixeleffects.color.GrayscaleEffect", "com.developedbyme.utils.canvas.pixeleffects.PixelEffectBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.utils.canvas.pixeleffects.color.GrayscaleEffect");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.utils.canvas.pixeleffects.color.GrayscaleEffect::_init");
	...
	objectFunctions.applyEffect = function(aInputGraphics, aOutputGraphics, aWidth, aHeight, aOffsetX, aOffsetY) {
		//console.log("com.developedbyme.utils.canvas.pixeleffects.color.GrayscaleEffect::applyEffect");
