 ...
 */
dbm.registerClass("com.developedbyme.utils.canvas.PixelEffectLayer2d", "com.developedbyme.utils.canvas.CanvasRenderLayer2d", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.utils.canvas.PixelEffectLayer2d");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.utils.canvas.PixelEffectLayer2d::_init");
	...
	objectFunctions._drawGraphicsAndChildren = function(aContext, aNumberOfLinksToResolve) {
		//console.log("com.developedbyme.utils.canvas.PixelEffectLayer2d::_drawGraphicsAndChildren");
