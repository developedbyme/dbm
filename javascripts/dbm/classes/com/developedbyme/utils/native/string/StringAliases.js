dbm.registerClass("com.developedbyme.utils.native.string.StringAliases", "com.developedbyme.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.utils.native.string.StringAliases");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.utils.native.string.StringAliases::_init");
	...
	objectFunctions._getConvertedString = function(aString) {
		//console.log("com.developedbyme.utils.native.string.StringAliases::_getConvertedString");
	...
	objectFunctions._compareCharCodes = function(aCharCodes1, aCharCodes2, aStartPosition) {
		//console.log("com.developedbyme.utils.native.string.StringAliases::_compareCharCodes");
	...
	objectFunctions._getInsertPosition = function(aCharCodes) {
		//console.log("com.developedbyme.utils.native.string.StringAliases::_getInsertPosition");
