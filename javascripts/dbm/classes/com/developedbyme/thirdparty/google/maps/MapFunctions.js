...
dbm.registerClass("com.developedbyme.thirdparty.google.maps.MapFunctions", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.thirdparty.google.maps.MapFunctions");
	...
	staticFunctions.setRadius = function(aObject, aValue) {
		console.log("com.developedbyme.thirdparty.google.maps.MapFunctions::setRadius");
	...
	staticFunctions.setLocation = function(aObject, aLatitude, aLongitude) {
		console.log("com.developedbyme.thirdparty.google.maps.MapFunctions::setLocation");
