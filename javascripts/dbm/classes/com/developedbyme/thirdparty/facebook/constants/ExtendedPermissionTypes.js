dbm.registerClass("com.developedbyme.thirdparty.facebook.constants.ExtendedPermissionTypes", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.thirdparty.facebook.constants.ExtendedPermissionTypes");
	
	//REFERENCE: http://developers.facebook.com/docs/reference/login/extended-permissions/
	
	var ExtendedPermissionTypes = dbm.importClass("com.developedbyme.thirdparty.facebook.constants.ExtendedPermissionTypes");
