...
/**
 * Script breakdown for a keyword (eg. break, continue)
 */
dbm.registerClass("com.developedbyme.compiler.breakdown.ScriptBreakdownKeywordPart", "com.developedbyme.compiler.breakdown.ScriptBreakdownPart", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.compiler.breakdown.ScriptBreakdownKeywordPart");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.compiler.breakdown.ScriptBreakdownKeywordPart::_init");
		
		this.superCall();
		
		this._type = BreakdownTypes.KEYWORD;
		this._keyword = null;
	...
	objectFunctions._breakdown = function() {
		//console.log("com.developedbyme.compiler.breakdown.ScriptBreakdownKeywordPart::_breakdown");
		
		this._keyword = this._script;
	};
	
	objectFunctions.compile = function(aCompileData) {
		//console.log("com.developedbyme.compiler.breakdown.ScriptBreakdownKeywordPart::compile");
