dbm.registerClass("com.developedbyme.compiler.breakdown.ScriptBreakdownReturnPart", "com.developedbyme.compiler.breakdown.ScriptBreakdownPart", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.compiler.breakdown.ScriptBreakdownReturnPart");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.compiler.breakdown.ScriptBreakdownReturnPart::_init");
	...
	objectFunctions._breakdown = function() {
		//console.log("com.developedbyme.compiler.breakdown.ScriptBreakdownReturnPart::_breakdown");
		if(this._script !== "") {
