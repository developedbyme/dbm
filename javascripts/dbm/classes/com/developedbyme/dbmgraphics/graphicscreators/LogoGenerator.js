 ...
 */
dbm.registerClass("com.developedbyme.dbmgraphics.graphicscreators.LogoGenerator", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.dbmgraphics.graphicscreators.LogoGenerator");
