dbm.registerClass("com.developedbyme.constants.SvgPathCommandTypes", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.constants.SvgPathCommandTypes");
	//"use strict";
