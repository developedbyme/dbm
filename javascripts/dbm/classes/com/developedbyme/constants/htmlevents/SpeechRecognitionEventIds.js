dbm.registerClass("com.developedbyme.constants.htmlevents.SpeechRecognitionEventIds", null, function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.constants.htmlevents.SpeechRecognitionEventIds");
