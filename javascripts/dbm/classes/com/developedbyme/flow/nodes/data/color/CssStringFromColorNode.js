 ...
 */
dbm.registerClass("com.developedbyme.flow.nodes.data.color.CssStringFromColorNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.data.color.CssStringFromColorNode");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.data.color.CssStringFromColorNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.data.color.CssStringFromColorNode::_update");
