 ...
 */
dbm.registerClass("com.developedbyme.flow.nodes.data.color.RgbaColorFromValuesNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.data.color.RgbaColorFromValuesNode");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.data.color.RgbaColorFromValuesNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.data.color.RgbaColorFromValuesNode::_update");
