...
dbm.registerClass("com.developedbyme.flow.nodes.points.PointFromValuesNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.points.PointFromValuesNode");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.points.PointFromValuesNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.points.PointFromValuesNode::_update");
