...
dbm.registerClass("com.developedbyme.flow.nodes.text.PrefixSuffixStringNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.text.PrefixSuffixStringNode");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.text.PrefixSuffixStringNode::_init");
