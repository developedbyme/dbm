...
dbm.registerClass("com.developedbyme.flow.nodes.curves.CreateArcLengthCurveNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.curves.CreateArcLengthCurveNode");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.curves.CreateArcLengthCurveNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.curves.CreateArcLengthCurveNode::_update");
	...
	staticFunctions.create = function(aInputCurve, aStartParameter, aEndParameter, aStepLength) {
		//console.log("com.developedbyme.flow.nodes.curves.CreateArcLengthCurveNode::create");
