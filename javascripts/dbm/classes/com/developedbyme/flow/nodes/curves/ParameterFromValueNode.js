...
dbm.registerClass("com.developedbyme.flow.nodes.curves.ParameterFromValueNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.curves.ParameterFromValueNode");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.curves.ParameterFromValueNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.curves.ParameterFromValueNode::_update");
