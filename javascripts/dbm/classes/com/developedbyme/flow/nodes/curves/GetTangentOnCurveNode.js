...
dbm.registerClass("com.developedbyme.flow.nodes.curves.GetTangentOnCurveNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.curves.GetTangentOnCurveNode");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.curves.GetTangentOnCurveNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.curves.GetTangentOnCurveNode::_update");
		
		var curve = this._curve.getValueWithoutFlow();
		var parameter = this._parameter.getValueWithoutFlow();
		curve.getTangentOnCurve(parameter, this._tempPoint);
