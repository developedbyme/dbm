...
dbm.registerClass("com.developedbyme.flow.nodes.curves.CreateLineFromPointNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.curves.CreateLineFromPointNode");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.curves.CreateLineFromPointNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.curves.CreateLineFromPointNode::_update");
		//console.log(this);
	...
	staticFunctions.create = function(aX, aY, aLength, aAngle) {
		//console.log("com.developedbyme.flow.nodes.curves.CreateLineFromPointNode::create");
