...
dbm.registerClass("com.developedbyme.flow.nodes.curves.CreateCircleCurveNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.curves.CreateCircleCurveNode::_update");
		//console.log(this);
	...
	staticFunctions.create = function(aX, aY, aRadius, aNumberOfSegments, aStartAngle) {
		//console.log("com.developedbyme.flow.nodes.curves.CreateCircleCurveNode::create");
