dbm.registerClass("com.developedbyme.flow.nodes.display.svg.TransformSvgElementNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.display.svg.TransformSvgElementNode");
	
	var TransformSvgElementNode = dbm.importClass("com.developedbyme.flow.nodes.display.svg.TransformSvgElementNode");
	
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.display.svg.TransformSvgElementNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.display.svg.TransformSvgElementNode::_update");
