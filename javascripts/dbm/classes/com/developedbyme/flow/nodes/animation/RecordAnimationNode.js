 ...
 */
dbm.registerClass("com.developedbyme.flow.nodes.animation.RecordAnimationNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.animation.RecordAnimationNode");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.animation.RecordAnimationNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.animation.RecordAnimationNode::_update");
	...
	objectFunctions.setTimeline = function(aTimeline) {
		//console.log("com.developedbyme.flow.nodes.animation.RecordAnimationNode::setTimeline");
