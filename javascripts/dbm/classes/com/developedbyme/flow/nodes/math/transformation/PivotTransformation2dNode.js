 ...
 */
dbm.registerClass("com.developedbyme.flow.nodes.math.transformation.PivotTransformation2dNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.math.transformation.PivotTransformation2dNode");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.math.transformation.PivotTransformation2dNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.math.transformation.PivotTransformation2dNode::_update");
	...
	staticFunctions.create = function(aPivotX, aPivotY, aTransformationMatrix) {
		//console.log("com.developedbyme.flow.nodes.math.transformation.PivotTransformation2dNode::create");
