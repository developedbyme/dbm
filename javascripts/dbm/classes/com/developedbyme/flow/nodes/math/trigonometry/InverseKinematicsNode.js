dbm.registerClass("com.developedbyme.flow.nodes.math.trigonometry.InverseKinematicsNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.math.trigonometry.InverseKinematicsNode");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.math.trigonometry.InverseKinematicsNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.math.trigonometry.InverseKinematicsNode::_update");
