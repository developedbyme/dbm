dbm.registerClass("com.developedbyme.flow.nodes.math.geometry.FitRectangleNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.math.geometry.FitRectangleNode");
	
	var FitRectangleNode = dbm.importClass("com.developedbyme.flow.nodes.math.geometry.FitRectangleNode");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.math.geometry.FitRectangleNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.math.geometry.FitRectangleNode::_update");
