...
dbm.registerClass("com.developedbyme.flow.nodes.math.geometry.PositionRectangleNode", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.nodes.math.geometry.PositionRectangleNode");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.nodes.math.geometry.PositionRectangleNode::_init");
	...
	objectFunctions._update = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.nodes.math.geometry.PositionRectangleNode::_update");
	...
	staticFunctions.create = function(aOuterRectangle, aInnerRectangle, aOuterParameterX, aOuterParameterY, aInnerParameterX, aInnerParameterY, aOffsetX, aOffsetY) {
		//console.log("com.developedbyme.flow.nodes.math.geometry.PositionRectangleNode::create");
