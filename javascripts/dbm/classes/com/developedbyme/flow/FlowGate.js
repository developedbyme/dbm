 ...
 */
dbm.registerClass("com.developedbyme.flow.FlowGate", "com.developedbyme.core.FlowBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.flow.FlowGate");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.flow.FlowGate::_init");
	...
	objectFunctions.updateFlow = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.flow.FlowGate::updateFlow");
	...
	staticFunctions.create = function(aInputConnection, aOutputConnection) {
		//console.log("com.developedbyme.flow.FlowGate::create");
