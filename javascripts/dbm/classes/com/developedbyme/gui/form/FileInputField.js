 ...
 */
dbm.registerClass("com.developedbyme.gui.form.FileInputField", "com.developedbyme.gui.DisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.gui.form.FileInputField");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.gui.form.FileInputField::_init");
	...
	objectFunctions._change = function() {
		console.log("com.developedbyme.gui.form.FileInputField::_change");
		console.log(this);
	...
	objectFunctions.triggerDialog = function() {
		console.log("com.developedbyme.gui.form.FileInputField::triggerDialog");
