...
dbm.registerClass("com.developedbyme.gui.svg.SvgLayer", "com.developedbyme.gui.svg.SvgDisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.gui.svg.SvgLayer");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.gui.svg.SvgLayer::_init");
	...
	objectFunctions.addGraphics = function(aGraphics) {
		//console.log("com.developedbyme.gui.svg.SvgLayer::addGraphics");
	...
	staticFunctions.createOnParent = function(aParentOrDocument, aAddToParent, aAttributes) {
		//console.log("com.developedbyme.gui.svg.SvgLayer::createOnParent (static)");
