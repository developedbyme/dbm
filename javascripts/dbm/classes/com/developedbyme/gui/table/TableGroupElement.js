...
dbm.registerClass("com.developedbyme.gui.table.TableGroupElement", "com.developedbyme.gui.DisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.gui.table.TableGroupElement");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.gui.table.TableGroupElement::_init");
	...
	objectFunctions.setAllReferencesToNull = function() {
		//console.log("com.developedbyme.gui.table.TableGroupElement::setAllReferencesToNull");
