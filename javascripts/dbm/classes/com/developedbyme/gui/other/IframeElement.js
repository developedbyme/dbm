...
dbm.registerClass("com.developedbyme.gui.other.IframeElement", "com.developedbyme.gui.DisplayBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.gui.other.IframeElement::_init");
	...
	staticFunctions.create = function(aParentOrDocument, aAddToParent, aUrl, aAttributes) {
		//console.log("com.developedbyme.gui.other.IframeElement::create (static)");
