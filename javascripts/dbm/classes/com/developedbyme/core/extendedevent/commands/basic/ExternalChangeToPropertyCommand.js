...
dbm.registerClass("com.developedbyme.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand", "com.developedbyme.core.extendedevent.commands.CommandBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand::_init");
	...
	objectFunctions.perform = function(aEventDataObject) {
		//console.log("com.developedbyme.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand::perform");
	...
	staticFunctions.createCommand = function(aProperty, aValue) {
		//console.log("com.developedbyme.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand::createCommand (static)");
	...
	staticFunctions.createSetPropertyOnObjectCommand = function(aObject, aPropertyName, aValue) {
		//console.log("com.developedbyme.core.extendedevent.commands.basic.ExternalChangeToPropertyCommand::createSetPropertyOnObjectCommand (static)");
