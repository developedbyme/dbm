...
dbm.registerClass("com.developedbyme.core.extendedevent.commands.animation.timeline.AnimateTimelineCommand", "com.developedbyme.core.extendedevent.commands.CommandBaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.extendedevent.commands.animation.timeline.AnimateTimelineCommand");
	
	var AnimateTimelineCommand = dbm.importClass("com.developedbyme.core.extendedevent.commands.animation.timeline.AnimateTimelineCommand");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.core.extendedevent.commands.animation.timeline.AnimateTimelineCommand::_init");
	...
	objectFunctions.perform = function(aEventDataObject) {
		//console.log("com.developedbyme.core.extendedevent.commands.animation.timeline.AnimateTimelineCommand::perform");
