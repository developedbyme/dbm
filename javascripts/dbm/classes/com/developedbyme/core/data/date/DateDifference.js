...
dbm.registerClass("com.developedbyme.core.data.date.DateDifference", "com.developedbyme.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.data.date.DateDifference");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.core.data.date.DateDifference::_init");
	...
	objectFunctions.setValues = function(aYears, aMonths, aDays, aHours, aMinutes, aSeconds) {
		//console.log("com.developedbyme.core.data.date.DateDifference::setValues");
	...
	staticFunctions.create = function(aYears, aMonths, aDays, aHours, aMinutes, aSeconds) {
		//console.log("com.developedbyme.core.data.date.DateDifference::create (static)");
	...
	staticFunctions.createWithoutValues = function() {
		//console.log("com.developedbyme.core.data.date.DateDifference::createWithoutValues (static)");
		//console.log(aOldValue, aNewValue);
		var newDateDifference = (new DateDifference()).init();
