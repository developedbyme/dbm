 ...
 */
dbm.registerClass("com.developedbyme.core.globalobjects.assetrepository.assets.FileReaderAsset", "com.developedbyme.core.globalobjects.assetrepository.assets.Asset", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.globalobjects.assetrepository.assets.FileReaderAsset");
	//"use strict";
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.core.globalobjects.assetrepository.assets.FileReaderAsset::_init");
	...
	objectFunctions.setFile = function(aFile) {
		//console.log("com.developedbyme.core.globalobjects.assetrepository.assets.FileReaderAsset::setFile");
		//console.log(aUrl);
	...
	objectFunctions._setupData = function() {
		//console.log("com.developedbyme.core.globalobjects.assetrepository.assets.FileReaderAsset::_setupData");
	...
	objectFunctions.load = function() {
		//console.log("com.developedbyme.core.globalobjects.assetrepository.assets.FileReaderAsset::load");
