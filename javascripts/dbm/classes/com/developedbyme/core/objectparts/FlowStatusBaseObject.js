 ...
 */
dbm.registerClass("com.developedbyme.core.objectparts.FlowStatusBaseObject", "com.developedbyme.core.BaseObject", function(objectFunctions, staticFunctions, ClassReference) {
	//console.log("com.developedbyme.core.objectparts.FlowStatusBaseObject");
	//"use strict";
	
	//Self reference
	var FlowStatusBaseObject = dbm.importClass("com.developedbyme.core.objectparts.FlowStatusBaseObject");
	...
	objectFunctions._init = function() {
		//console.log("com.developedbyme.core.objectparts.FlowStatusBaseObject::_init");
	...
	objectFunctions.getFlowUpdateNumber = function() {
		//console.log("com.developedbyme.core.objectparts.FlowStatusBaseObject::getFlowUpdateNumber");
	...
	objectFunctions._internalFunctionality_setFlowUpdateNumber = function(aFlowUpdateNumber) {
		//console.log("com.developedbyme.core.objectparts.FlowStatusBaseObject::_internalFunctionality_setFlowUpdateNumber");
		this.flowUpdateNumber = aFlowUpdateNumber;
	};
	...
	objectFunctions.fillWithAllOutputConnections = function(aReturnArray) {
		//console.log("com.developedbyme.core.objectparts.FlowStatusBaseObject::fillWithAllOutputConnections");
