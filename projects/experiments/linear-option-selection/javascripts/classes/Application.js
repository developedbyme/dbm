...
dbm.registerClass("Application", "dbm.gui.abstract.startup.standalone.StandAlonePage", function(objectFunctions, staticFunctions, ClassReference) {
	...
	objectFunctions._changeShowingItem = function(aIndex, aDelay) {
		//console.log("Application::_changeShowingItem");
		//console.log(aIndex);
	...
	objectFunctions._createNewOption = function() {
		//console.log("Application::_createNewOption");
	...
	objectFunctions._touchStarted = function() {
		//console.log("Application::_touchStarted");
	...
	objectFunctions._touchUpdate = function() {
		//console.log("Application::_touchUpdate");
	...
	objectFunctions._touchEnded = function() {
		//console.log("Application::_touchEnded");
