...
export default class ObjectList extends Dbm.react.BaseObject {
    ...
    _renderMainElement() {
        ...
        return React.createElement("div", {className: "content-narrow"}, 
            React.createElement(Dbm.react.admin.objects.ObjectList, {objectType: this.context.blockData.objectType, encodings: encodings, nameField: this.context.blockData.nameField})
        );
    }
}